...
d <- [valueDef("__builtin_ia32_pf2id", builtinFunctionValueItem( {-  __attribute__((__vector_size__(2))) signed int(__attribute__((__vector_size__(2))) float) -}
    functionType(vectorType(builtinType(nilQualifier(), signedType(intType())), 2), protoFunctionType([vectorType(builtinType(nilQualifier(), realType(floatType())), 2)], false), nilQualifier()),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_ia32_pfacc", builtinFunctionValueItem( {-  __attribute__((__vector_size__(2))) float(__attribute__((__vector_size__(2))) float, __attribute__((__vector_size__(2))) float) -}
    functionType(vectorType(builtinType(nilQualifier(), realType(floatType())), 2), protoFunctionType([vectorType(builtinType(nilQualifier(), realType(floatType())), 2), vectorType(builtinType(nilQualifier(), realType(floatType())), 2)], false), nilQualifier()),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__builtin_ia32_pfcmpeq", builtinFunctionValueItem( {-  __attribute__((__vector_size__(2))) signed int(__attribute__((__vector_size__(2))) float, __attribute__((__vector_size__(2))) float) -}
    functionType(vectorType(builtinType(nilQualifier(), signedType(intType())), 2), protoFunctionType([vectorType(builtinType(nilQualifier(), realType(floatType())), 2), vectorType(builtinType(nilQualifier(), realType(floatType())), 2)], false), nilQualifier()),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__builtin_ia32_pfrcp", builtinFunctionValueItem( {-  __attribute__((__vector_size__(2))) float(__attribute__((__vector_size__(2))) float) -}
    functionType(vectorType(builtinType(nilQualifier(), realType(floatType())), 2), protoFunctionType([vectorType(builtinType(nilQualifier(), realType(floatType())), 2)], false), nilQualifier()),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__builtin_ia32_pi2fd", builtinFunctionValueItem( {-  __attribute__((__vector_size__(2))) float(__attribute__((__vector_size__(2))) signed int) -}
    functionType(vectorType(builtinType(nilQualifier(), realType(floatType())), 2), protoFunctionType([vectorType(builtinType(nilQualifier(), signedType(intType())), 2)], false), nilQualifier()),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_ia32_pmulhrw", builtinFunctionValueItem( {-  __attribute__((__vector_size__(4))) signed short(__attribute__((__vector_size__(4))) signed short, __attribute__((__vector_size__(4))) signed short) -}
    functionType(vectorType(builtinType(nilQualifier(), signedType(shortType())), 4), protoFunctionType([vectorType(builtinType(nilQualifier(), signedType(shortType())), 4), vectorType(builtinType(nilQualifier(), signedType(shortType())), 4)], false), nilQualifier()),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__builtin_ia32_pswapdsi", builtinFunctionValueItem( {-  __attribute__((__vector_size__(2))) signed int(__attribute__((__vector_size__(2))) signed int) -}
    functionType(vectorType(builtinType(nilQualifier(), signedType(intType())), 2), protoFunctionType([vectorType(builtinType(nilQualifier(), signedType(intType())), 2)], false), nilQualifier()),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__builtin_ia32_paddd", builtinFunctionValueItem( {-  __attribute__((__vector_size__(2))) signed int(__attribute__((__vector_size__(2))) signed int, __attribute__((__vector_size__(2))) signed int) -}
    functionType(vectorType(builtinType(nilQualifier(), signedType(intType())), 2), protoFunctionType([vectorType(builtinType(nilQualifier(), signedType(intType())), 2), vectorType(builtinType(nilQualifier(), signedType(intType())), 2)], false), nilQualifier()),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__builtin_ia32_pmaddwd", builtinFunctionValueItem( {-  __attribute__((__vector_size__(2))) signed int(__attribute__((__vector_size__(4))) signed short, __attribute__((__vector_size__(4))) signed short) -}
    functionType(vectorType(builtinType(nilQualifier(), signedType(intType())), 2), protoFunctionType([vectorType(builtinType(nilQualifier(), signedType(shortType())), 4), vectorType(builtinType(nilQualifier(), signedType(shortType())), 4)], false), nilQualifier()),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_ia32_pand", builtinFunctionValueItem( {-  __attribute__((__vector_size__(1))) signed long long(__attribute__((__vector_size__(1))) signed long long, __attribute__((__vector_size__(1))) signed long long) -}
    functionType(vectorType(builtinType(nilQualifier(), signedType(longlongType())), 1), protoFunctionType([vectorType(builtinType(nilQualifier(), signedType(longlongType())), 1), vectorType(builtinType(nilQualifier(), signedType(longlongType())), 1)], false), nilQualifier()),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__builtin_ia32_psllw", builtinFunctionValueItem( {-  __attribute__((__vector_size__(4))) signed short(__attribute__((__vector_size__(4))) signed short, __attribute__((__vector_size__(1))) signed long long) -}
    functionType(vectorType(builtinType(nilQualifier(), signedType(shortType())), 4), protoFunctionType([vectorType(builtinType(nilQualifier(), signedType(shortType())), 4), vectorType(builtinType(nilQualifier(), signedType(longlongType())), 1)], false), nilQualifier()),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_ia32_pslld", builtinFunctionValueItem( {-  __attribute__((__vector_size__(2))) signed int(__attribute__((__vector_size__(2))) signed int, __attribute__((__vector_size__(1))) signed long long) -}
    functionType(vectorType(builtinType(nilQualifier(), signedType(intType())), 2), protoFunctionType([vectorType(builtinType(nilQualifier(), signedType(intType())), 2), vectorType(builtinType(nilQualifier(), signedType(longlongType())), 1)], false), nilQualifier()),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__builtin_ia32_psllwi", builtinFunctionValueItem( {-  __attribute__((__vector_size__(4))) signed short(__attribute__((__vector_size__(4))) signed short, signed int) -}
    functionType(vectorType(builtinType(nilQualifier(), signedType(shortType())), 4), protoFunctionType([vectorType(builtinType(nilQualifier(), signedType(shortType())), 4), builtinType(nilQualifier(), signedType(intType()))], false), nilQualifier()),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_ia32_pslldi", builtinFunctionValueItem( {-  __attribute__((__vector_size__(2))) signed int(__attribute__((__vector_size__(2))) signed int, signed int) -}
    functionType(vectorType(builtinType(nilQualifier(), signedType(intType())), 2), protoFunctionType([vectorType(builtinType(nilQualifier(), signedType(intType())), 2), builtinType(nilQualifier(), signedType(intType()))], false), nilQualifier()),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_ia32_psllqi", builtinFunctionValueItem( {-  __attribute__((__vector_size__(1))) signed long long(__attribute__((__vector_size__(1))) signed long long, signed int) -}
    functionType(vectorType(builtinType(nilQualifier(), signedType(longlongType())), 1), protoFunctionType([vectorType(builtinType(nilQualifier(), signedType(longlongType())), 1), builtinType(nilQualifier(), signedType(intType()))], false), nilQualifier()),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__builtin_ia32_packsswb", builtinFunctionValueItem( {-  __attribute__((__vector_size__(8))) char(__attribute__((__vector_size__(4))) signed short, __attribute__((__vector_size__(4))) signed short) -}
    functionType(vectorType(builtinType(nilQualifier(), signedType(charType())), 8), protoFunctionType([vectorType(builtinType(nilQualifier(), signedType(shortType())), 4), vectorType(builtinType(nilQualifier(), signedType(shortType())), 4)], false), nilQualifier()),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_ia32_packssdw", builtinFunctionValueItem( {-  __attribute__((__vector_size__(4))) signed short(__attribute__((__vector_size__(2))) signed int, __attribute__((__vector_size__(2))) signed int) -}
    functionType(vectorType(builtinType(nilQualifier(), signedType(shortType())), 4), protoFunctionType([vectorType(builtinType(nilQualifier(), signedType(intType())), 2), vectorType(builtinType(nilQualifier(), signedType(intType())), 2)], false), nilQualifier()),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__builtin_ia32_movntq", builtinFunctionValueItem( {-  void(__attribute__((__vector_size__(1))) signed long long * , __attribute__((__vector_size__(1))) signed long long) -}
    functionType(builtinType(nilQualifier(), voidType()), protoFunctionType([pointerType(nilQualifier(), vectorType(builtinType(nilQualifier(), signedType(longlongType())), 1)), vectorType(builtinType(nilQualifier(), signedType(longlongType())), 1)], false), nilQualifier()),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_ia32_vec_init_v2si", builtinFunctionValueItem( {-  __attribute__((__vector_size__(2))) signed int(signed int, signed int) -}
    functionType(vectorType(builtinType(nilQualifier(), signedType(intType())), 2), protoFunctionType([builtinType(nilQualifier(), signedType(intType())), builtinType(nilQualifier(), signedType(intType()))], false), nilQualifier()),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_ia32_vec_init_v4hi", builtinFunctionValueItem( {-  __attribute__((__vector_size__(4))) signed short(signed short, signed short, signed short, signed short) -}
    functionType(vectorType(builtinType(nilQualifier(), signedType(shortType())), 4), protoFunctionType([builtinType(nilQualifier(), signedType(shortType())), builtinType(nilQualifier(), signedType(shortType())), builtinType(nilQualifier(), signedType(shortType())), builtinType(nilQualifier(), signedType(shortType()))], false), nilQualifier()),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__builtin_ia32_vec_ext_v2si", builtinFunctionValueItem( {-  signed int(__attribute__((__vector_size__(2))) signed int, signed int) -}
    functionType(builtinType(nilQualifier(), signedType(intType())), protoFunctionType([vectorType(builtinType(nilQualifier(), signedType(intType())), 2), builtinType(nilQualifier(), signedType(intType()))], false), nilQualifier()),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_ia32_cvtpi2ps", builtinFunctionValueItem( {-  __attribute__((__vector_size__(4))) float(__attribute__((__vector_size__(4))) float, __attribute__((__vector_size__(2))) signed int) -}
    functionType(vectorType(builtinType(nilQualifier(), realType(floatType())), 4), protoFunctionType([vectorType(builtinType(nilQualifier(), realType(floatType())), 4), vectorType(builtinType(nilQualifier(), signedType(intType())), 2)], false), nilQualifier()),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_ia32_cvtps2pi", builtinFunctionValueItem( {-  __attribute__((__vector_size__(2))) signed int(__attribute__((__vector_size__(4))) float) -}
    functionType(vectorType(builtinType(nilQualifier(), signedType(intType())), 2), protoFunctionType([vectorType(builtinType(nilQualifier(), realType(floatType())), 4)], false), nilQualifier()),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__builtin_ia32_psadbw", builtinFunctionValueItem( {-  __attribute__((__vector_size__(4))) signed short(__attribute__((__vector_size__(8))) char, __attribute__((__vector_size__(8))) char) -}
    functionType(vectorType(builtinType(nilQualifier(), signedType(shortType())), 4), protoFunctionType([vectorType(builtinType(nilQualifier(), signedType(charType())), 8), vectorType(builtinType(nilQualifier(), signedType(charType())), 8)], false), nilQualifier()),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_ia32_pshufw", builtinFunctionValueItem( {-  __attribute__((__vector_size__(4))) signed short(__attribute__((__vector_size__(4))) signed short, char) -}
    functionType(vectorType(builtinType(nilQualifier(), signedType(shortType())), 4), protoFunctionType([vectorType(builtinType(nilQualifier(), signedType(shortType())), 4), builtinType(nilQualifier(), signedType(charType()))], false), nilQualifier()),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_ia32_cvtpd2pi", builtinFunctionValueItem( {-  __attribute__((__vector_size__(2))) signed int(__attribute__((__vector_size__(2))) double) -}
    functionType(vectorType(builtinType(nilQualifier(), signedType(intType())), 2), protoFunctionType([vectorType(builtinType(nilQualifier(), realType(doubleType())), 2)], false), nilQualifier()),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_ia32_cvtpi2pd", builtinFunctionValueItem( {-  __attribute__((__vector_size__(2))) double(__attribute__((__vector_size__(2))) signed int) -}
    functionType(vectorType(builtinType(nilQualifier(), realType(doubleType())), 2), protoFunctionType([vectorType(builtinType(nilQualifier(), signedType(intType())), 2)], false), nilQualifier()),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__builtin_ia32_pmuludq", builtinFunctionValueItem( {-  __attribute__((__vector_size__(1))) signed long long(__attribute__((__vector_size__(2))) signed int, __attribute__((__vector_size__(2))) signed int) -}
    functionType(vectorType(builtinType(nilQualifier(), signedType(longlongType())), 1), protoFunctionType([vectorType(builtinType(nilQualifier(), signedType(intType())), 2), vectorType(builtinType(nilQualifier(), signedType(intType())), 2)], false), nilQualifier()),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__builtin_ia32_pabsw", builtinFunctionValueItem( {-  __attribute__((__vector_size__(4))) signed short(__attribute__((__vector_size__(4))) signed short) -}
    functionType(vectorType(builtinType(nilQualifier(), signedType(shortType())), 4), protoFunctionType([vectorType(builtinType(nilQualifier(), signedType(shortType())), 4)], false), nilQualifier()),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__builtin_ia32_comieq", builtinFunctionValueItem( {-  signed int(__attribute__((__vector_size__(4))) float, __attribute__((__vector_size__(4))) float) -}
    functionType(builtinType(nilQualifier(), signedType(intType())), protoFunctionType([vectorType(builtinType(nilQualifier(), realType(floatType())), 4), vectorType(builtinType(nilQualifier(), realType(floatType())), 4)], false), nilQualifier()),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__builtin_ia32_comisdeq", builtinFunctionValueItem( {-  signed int(__attribute__((__vector_size__(2))) double, __attribute__((__vector_size__(2))) double) -}
    functionType(builtinType(nilQualifier(), signedType(intType())), protoFunctionType([vectorType(builtinType(nilQualifier(), realType(doubleType())), 2), vectorType(builtinType(nilQualifier(), realType(doubleType())), 2)], false), nilQualifier()),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__builtin_ia32_cmpps", builtinFunctionValueItem( {-  __attribute__((__vector_size__(4))) float(__attribute__((__vector_size__(4))) float, __attribute__((__vector_size__(4))) float, char) -}
    functionType(vectorType(builtinType(nilQualifier(), realType(floatType())), 4), protoFunctionType([vectorType(builtinType(nilQualifier(), realType(floatType())), 4), vectorType(builtinType(nilQualifier(), realType(floatType())), 4), builtinType(nilQualifier(), signedType(charType()))], false), nilQualifier()),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__builtin_ia32_minps", builtinFunctionValueItem( {-  __attribute__((__vector_size__(4))) float(__attribute__((__vector_size__(4))) float, __attribute__((__vector_size__(4))) float) -}
    functionType(vectorType(builtinType(nilQualifier(), realType(floatType())), 4), protoFunctionType([vectorType(builtinType(nilQualifier(), realType(floatType())), 4), vectorType(builtinType(nilQualifier(), realType(floatType())), 4)], false), nilQualifier()),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__builtin_ia32_cmppd", builtinFunctionValueItem( {-  __attribute__((__vector_size__(2))) double(__attribute__((__vector_size__(2))) double, __attribute__((__vector_size__(2))) double, char) -}
    functionType(vectorType(builtinType(nilQualifier(), realType(doubleType())), 2), protoFunctionType([vectorType(builtinType(nilQualifier(), realType(doubleType())), 2), vectorType(builtinType(nilQualifier(), realType(doubleType())), 2), builtinType(nilQualifier(), signedType(charType()))], false), nilQualifier()),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__builtin_ia32_minpd", builtinFunctionValueItem( {-  __attribute__((__vector_size__(2))) double(__attribute__((__vector_size__(2))) double, __attribute__((__vector_size__(2))) double) -}
    functionType(vectorType(builtinType(nilQualifier(), realType(doubleType())), 2), protoFunctionType([vectorType(builtinType(nilQualifier(), realType(doubleType())), 2), vectorType(builtinType(nilQualifier(), realType(doubleType())), 2)], false), nilQualifier()),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__builtin_ia32_packsswb128", builtinFunctionValueItem( {-  __attribute__((__vector_size__(16))) char(__attribute__((__vector_size__(8))) signed short, __attribute__((__vector_size__(8))) signed short) -}
    functionType(vectorType(builtinType(nilQualifier(), signedType(charType())), 16), protoFunctionType([vectorType(builtinType(nilQualifier(), signedType(shortType())), 8), vectorType(builtinType(nilQualifier(), signedType(shortType())), 8)], false), nilQualifier()),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_ia32_packssdw128", builtinFunctionValueItem( {-  __attribute__((__vector_size__(8))) signed short(__attribute__((__vector_size__(4))) signed int, __attribute__((__vector_size__(4))) signed int) -}
    functionType(vectorType(builtinType(nilQualifier(), signedType(shortType())), 8), protoFunctionType([vectorType(builtinType(nilQualifier(), signedType(intType())), 4), vectorType(builtinType(nilQualifier(), signedType(intType())), 4)], false), nilQualifier()),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__builtin_ia32_phaddd128", builtinFunctionValueItem( {-  __attribute__((__vector_size__(4))) signed int(__attribute__((__vector_size__(4))) signed int, __attribute__((__vector_size__(4))) signed int) -}
    functionType(vectorType(builtinType(nilQualifier(), signedType(intType())), 4), protoFunctionType([vectorType(builtinType(nilQualifier(), signedType(intType())), 4), vectorType(builtinType(nilQualifier(), signedType(intType())), 4)], false), nilQualifier()),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__builtin_ia32_pmaddubsw128", builtinFunctionValueItem( {-  __attribute__((__vector_size__(8))) signed short(__attribute__((__vector_size__(16))) char, __attribute__((__vector_size__(16))) char) -}
    functionType(vectorType(builtinType(nilQualifier(), signedType(shortType())), 8), protoFunctionType([vectorType(builtinType(nilQualifier(), signedType(charType())), 16), vectorType(builtinType(nilQualifier(), signedType(charType())), 16)], false), nilQualifier()),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__builtin_ia32_pabsd128", builtinFunctionValueItem( {-  __attribute__((__vector_size__(4))) signed int(__attribute__((__vector_size__(4))) signed int) -}
    functionType(vectorType(builtinType(nilQualifier(), signedType(intType())), 4), protoFunctionType([vectorType(builtinType(nilQualifier(), signedType(intType())), 4)], false), nilQualifier()),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__builtin_ia32_cvtss2si", builtinFunctionValueItem( {-  signed int(__attribute__((__vector_size__(4))) float) -}
    functionType(builtinType(nilQualifier(), signedType(intType())), protoFunctionType([vectorType(builtinType(nilQualifier(), realType(floatType())), 4)], false), nilQualifier()),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_ia32_cvtss2si64", builtinFunctionValueItem( {-  signed long long(__attribute__((__vector_size__(4))) float) -}
    functionType(builtinType(nilQualifier(), signedType(longlongType())), protoFunctionType([vectorType(builtinType(nilQualifier(), realType(floatType())), 4)], false), nilQualifier()),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_ia32_storeups", builtinFunctionValueItem( {-  void(float * , __attribute__((__vector_size__(4))) float) -}
    functionType(builtinType(nilQualifier(), voidType()), protoFunctionType([pointerType(nilQualifier(), builtinType(nilQualifier(), realType(floatType()))), vectorType(builtinType(nilQualifier(), realType(floatType())), 4)], false), nilQualifier()),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_ia32_storehps", builtinFunctionValueItem( {-  void(__attribute__((__vector_size__(2))) signed int * , __attribute__((__vector_size__(4))) float) -}
    functionType(builtinType(nilQualifier(), voidType()), protoFunctionType([pointerType(nilQualifier(), vectorType(builtinType(nilQualifier(), signedType(intType())), 2)), vectorType(builtinType(nilQualifier(), realType(floatType())), 4)], false), nilQualifier()),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__builtin_ia32_rcpps", builtinFunctionValueItem( {-  __attribute__((__vector_size__(4))) float(__attribute__((__vector_size__(4))) float) -}
    functionType(vectorType(builtinType(nilQualifier(), realType(floatType())), 4), protoFunctionType([vectorType(builtinType(nilQualifier(), realType(floatType())), 4)], false), nilQualifier()),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__builtin_ia32_storeupd", builtinFunctionValueItem( {-  void(double * , __attribute__((__vector_size__(2))) double) -}
    functionType(builtinType(nilQualifier(), voidType()), protoFunctionType([pointerType(nilQualifier(), builtinType(nilQualifier(), realType(doubleType()))), vectorType(builtinType(nilQualifier(), realType(doubleType())), 2)], false), nilQualifier()),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_ia32_movmskpd", builtinFunctionValueItem( {-  signed int(__attribute__((__vector_size__(2))) double) -}
    functionType(builtinType(nilQualifier(), signedType(intType())), protoFunctionType([vectorType(builtinType(nilQualifier(), realType(doubleType())), 2)], false), nilQualifier()),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__builtin_ia32_movntdq", builtinFunctionValueItem( {-  void(__attribute__((__vector_size__(2))) signed long long * , __attribute__((__vector_size__(2))) signed long long) -}
    functionType(builtinType(nilQualifier(), voidType()), protoFunctionType([pointerType(nilQualifier(), vectorType(builtinType(nilQualifier(), signedType(longlongType())), 2)), vectorType(builtinType(nilQualifier(), signedType(longlongType())), 2)], false), nilQualifier()),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_ia32_psadbw128", builtinFunctionValueItem( {-  __attribute__((__vector_size__(2))) signed long long(__attribute__((__vector_size__(16))) char, __attribute__((__vector_size__(16))) char) -}
    functionType(vectorType(builtinType(nilQualifier(), signedType(longlongType())), 2), protoFunctionType([vectorType(builtinType(nilQualifier(), signedType(charType())), 16), vectorType(builtinType(nilQualifier(), signedType(charType())), 16)], false), nilQualifier()),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_ia32_sqrtpd", builtinFunctionValueItem( {-  __attribute__((__vector_size__(2))) double(__attribute__((__vector_size__(2))) double) -}
    functionType(vectorType(builtinType(nilQualifier(), realType(doubleType())), 2), protoFunctionType([vectorType(builtinType(nilQualifier(), realType(doubleType())), 2)], false), nilQualifier()),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__builtin_ia32_cvtdq2pd", builtinFunctionValueItem( {-  __attribute__((__vector_size__(2))) double(__attribute__((__vector_size__(4))) signed int) -}
    functionType(vectorType(builtinType(nilQualifier(), realType(doubleType())), 2), protoFunctionType([vectorType(builtinType(nilQualifier(), signedType(intType())), 4)], false), nilQualifier()),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_ia32_cvtdq2ps", builtinFunctionValueItem( {-  __attribute__((__vector_size__(4))) float(__attribute__((__vector_size__(4))) signed int) -}
    functionType(vectorType(builtinType(nilQualifier(), realType(floatType())), 4), protoFunctionType([vectorType(builtinType(nilQualifier(), signedType(intType())), 4)], false), nilQualifier()),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_ia32_cvtpd2dq", builtinFunctionValueItem( {-  __attribute__((__vector_size__(2))) signed long long(__attribute__((__vector_size__(2))) double) -}
    functionType(vectorType(builtinType(nilQualifier(), signedType(longlongType())), 2), protoFunctionType([vectorType(builtinType(nilQualifier(), realType(doubleType())), 2)], false), nilQualifier()),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_ia32_cvtpd2ps", builtinFunctionValueItem( {-  __attribute__((__vector_size__(4))) float(__attribute__((__vector_size__(2))) double) -}
    functionType(vectorType(builtinType(nilQualifier(), realType(floatType())), 4), protoFunctionType([vectorType(builtinType(nilQualifier(), realType(doubleType())), 2)], false), nilQualifier()),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_ia32_cvttpd2dq", builtinFunctionValueItem( {-  __attribute__((__vector_size__(4))) signed int(__attribute__((__vector_size__(2))) double) -}
    functionType(vectorType(builtinType(nilQualifier(), signedType(intType())), 4), protoFunctionType([vectorType(builtinType(nilQualifier(), realType(doubleType())), 2)], false), nilQualifier()),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__builtin_ia32_cvtsd2si64", builtinFunctionValueItem( {-  signed long long(__attribute__((__vector_size__(2))) double) -}
    functionType(builtinType(nilQualifier(), signedType(longlongType())), protoFunctionType([vectorType(builtinType(nilQualifier(), realType(doubleType())), 2)], false), nilQualifier()),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_ia32_cvtps2dq", builtinFunctionValueItem( {-  __attribute__((__vector_size__(4))) signed int(__attribute__((__vector_size__(4))) float) -}
    functionType(vectorType(builtinType(nilQualifier(), signedType(intType())), 4), protoFunctionType([vectorType(builtinType(nilQualifier(), realType(floatType())), 4)], false), nilQualifier()),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_ia32_cvtps2pd", builtinFunctionValueItem( {-  __attribute__((__vector_size__(2))) double(__attribute__((__vector_size__(4))) float) -}
    functionType(vectorType(builtinType(nilQualifier(), realType(doubleType())), 2), protoFunctionType([vectorType(builtinType(nilQualifier(), realType(floatType())), 4)], false), nilQualifier()),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__builtin_ia32_clflush", builtinFunctionValueItem( {-  void(const void * ) -}
    functionType(builtinType(nilQualifier(), voidType()), protoFunctionType([pointerType(nilQualifier(), builtinType(consQualifier(constQualifier(location=builtinLoc("host")), nilQualifier()), voidType()))], false), nilQualifier()),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__builtin_ia32_storedqu", builtinFunctionValueItem( {-  void(char * , __attribute__((__vector_size__(16))) char) -}
    functionType(builtinType(nilQualifier(), voidType()), protoFunctionType([pointerType(nilQualifier(), builtinType(nilQualifier(), signedType(charType()))), vectorType(builtinType(nilQualifier(), signedType(charType())), 16)], false), nilQualifier()),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_ia32_pmuludq128", builtinFunctionValueItem( {-  __attribute__((__vector_size__(2))) signed long long(__attribute__((__vector_size__(4))) signed int, __attribute__((__vector_size__(4))) signed int) -}
    functionType(vectorType(builtinType(nilQualifier(), signedType(longlongType())), 2), protoFunctionType([vectorType(builtinType(nilQualifier(), signedType(intType())), 4), vectorType(builtinType(nilQualifier(), signedType(intType())), 4)], false), nilQualifier()),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__builtin_ia32_pslldqi128", builtinFunctionValueItem( {-  __attribute__((__vector_size__(2))) signed long long(__attribute__((__vector_size__(2))) signed long long, signed int) -}
    functionType(vectorType(builtinType(nilQualifier(), signedType(longlongType())), 2), protoFunctionType([vectorType(builtinType(nilQualifier(), signedType(longlongType())), 2), builtinType(nilQualifier(), signedType(intType()))], false), nilQualifier()),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__builtin_ia32_psrlq128", builtinFunctionValueItem( {-  __attribute__((__vector_size__(2))) signed long long(__attribute__((__vector_size__(2))) signed long long, __attribute__((__vector_size__(2))) signed long long) -}
    functionType(vectorType(builtinType(nilQualifier(), signedType(longlongType())), 2), protoFunctionType([vectorType(builtinType(nilQualifier(), signedType(longlongType())), 2), vectorType(builtinType(nilQualifier(), signedType(longlongType())), 2)], false), nilQualifier()),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__builtin_ia32_pslldi128", builtinFunctionValueItem( {-  __attribute__((__vector_size__(4))) signed int(__attribute__((__vector_size__(4))) signed int, signed int) -}
    functionType(vectorType(builtinType(nilQualifier(), signedType(intType())), 4), protoFunctionType([vectorType(builtinType(nilQualifier(), signedType(intType())), 4), builtinType(nilQualifier(), signedType(intType()))], false), nilQualifier()),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__builtin_ia32_pmaddwd128", builtinFunctionValueItem( {-  __attribute__((__vector_size__(4))) signed int(__attribute__((__vector_size__(8))) signed short, __attribute__((__vector_size__(8))) signed short) -}
    functionType(vectorType(builtinType(nilQualifier(), signedType(intType())), 4), protoFunctionType([vectorType(builtinType(nilQualifier(), signedType(shortType())), 8), vectorType(builtinType(nilQualifier(), signedType(shortType())), 8)], false), nilQualifier()),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__builtin_ia32_lddqu", builtinFunctionValueItem( {-  __attribute__((__vector_size__(16))) char(const char * ) -}
    functionType(vectorType(builtinType(nilQualifier(), signedType(charType())), 16), protoFunctionType([pointerType(nilQualifier(), builtinType(consQualifier(constQualifier(location=builtinLoc("host")), nilQualifier()), signedType(charType())))], false), nilQualifier()),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__builtin_ia32_insertps128", builtinFunctionValueItem( {-  __attribute__((__vector_size__(4))) float(__attribute__((__vector_size__(4))) float, __attribute__((__vector_size__(4))) float, signed int) -}
    functionType(vectorType(builtinType(nilQualifier(), realType(floatType())), 4), protoFunctionType([vectorType(builtinType(nilQualifier(), realType(floatType())), 4), vectorType(builtinType(nilQualifier(), realType(floatType())), 4), builtinType(nilQualifier(), signedType(intType()))], false), nilQualifier()),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__builtin_ia32_pblendw128", builtinFunctionValueItem( {-  __attribute__((__vector_size__(8))) signed short(__attribute__((__vector_size__(8))) signed short, __attribute__((__vector_size__(8))) signed short, signed int) -}
    functionType(vectorType(builtinType(nilQualifier(), signedType(shortType())), 8), protoFunctionType([vectorType(builtinType(nilQualifier(), signedType(shortType())), 8), vectorType(builtinType(nilQualifier(), signedType(shortType())), 8), builtinType(nilQualifier(), signedType(intType()))], false), nilQualifier()),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_ia32_blendpd", builtinFunctionValueItem( {-  __attribute__((__vector_size__(2))) double(__attribute__((__vector_size__(2))) double, __attribute__((__vector_size__(2))) double, signed int) -}
    functionType(vectorType(builtinType(nilQualifier(), realType(doubleType())), 2), protoFunctionType([vectorType(builtinType(nilQualifier(), realType(doubleType())), 2), vectorType(builtinType(nilQualifier(), realType(doubleType())), 2), builtinType(nilQualifier(), signedType(intType()))], false), nilQualifier()),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__builtin_ia32_blendvpd", builtinFunctionValueItem( {-  __attribute__((__vector_size__(2))) double(__attribute__((__vector_size__(2))) double, __attribute__((__vector_size__(2))) double, __attribute__((__vector_size__(2))) double) -}
    functionType(vectorType(builtinType(nilQualifier(), realType(doubleType())), 2), protoFunctionType([vectorType(builtinType(nilQualifier(), realType(doubleType())), 2), vectorType(builtinType(nilQualifier(), realType(doubleType())), 2), vectorType(builtinType(nilQualifier(), realType(doubleType())), 2)], false), nilQualifier()),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_ia32_blendvps", builtinFunctionValueItem( {-  __attribute__((__vector_size__(4))) float(__attribute__((__vector_size__(4))) float, __attribute__((__vector_size__(4))) float, __attribute__((__vector_size__(4))) float) -}
    functionType(vectorType(builtinType(nilQualifier(), realType(floatType())), 4), protoFunctionType([vectorType(builtinType(nilQualifier(), realType(floatType())), 4), vectorType(builtinType(nilQualifier(), realType(floatType())), 4), vectorType(builtinType(nilQualifier(), realType(floatType())), 4)], false), nilQualifier()),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__builtin_ia32_pmovsxbd128", builtinFunctionValueItem( {-  __attribute__((__vector_size__(4))) signed int(__attribute__((__vector_size__(16))) char) -}
    functionType(vectorType(builtinType(nilQualifier(), signedType(intType())), 4), protoFunctionType([vectorType(builtinType(nilQualifier(), signedType(charType())), 16)], false), nilQualifier()),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_ia32_pmovsxbq128", builtinFunctionValueItem( {-  __attribute__((__vector_size__(2))) signed long long(__attribute__((__vector_size__(16))) char) -}
    functionType(vectorType(builtinType(nilQualifier(), signedType(longlongType())), 2), protoFunctionType([vectorType(builtinType(nilQualifier(), signedType(charType())), 16)], false), nilQualifier()),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_ia32_pmovsxbw128", builtinFunctionValueItem( {-  __attribute__((__vector_size__(8))) signed short(__attribute__((__vector_size__(16))) char) -}
    functionType(vectorType(builtinType(nilQualifier(), signedType(shortType())), 8), protoFunctionType([vectorType(builtinType(nilQualifier(), signedType(charType())), 16)], false), nilQualifier()),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_ia32_pmovsxdq128", builtinFunctionValueItem( {-  __attribute__((__vector_size__(2))) signed long long(__attribute__((__vector_size__(4))) signed int) -}
    functionType(vectorType(builtinType(nilQualifier(), signedType(longlongType())), 2), protoFunctionType([vectorType(builtinType(nilQualifier(), signedType(intType())), 4)], false), nilQualifier()),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_ia32_pmovsxwd128", builtinFunctionValueItem( {-  __attribute__((__vector_size__(4))) signed int(__attribute__((__vector_size__(8))) signed short) -}
    functionType(vectorType(builtinType(nilQualifier(), signedType(intType())), 4), protoFunctionType([vectorType(builtinType(nilQualifier(), signedType(shortType())), 8)], false), nilQualifier()),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_ia32_pmovsxwq128", builtinFunctionValueItem( {-  __attribute__((__vector_size__(2))) signed long long(__attribute__((__vector_size__(8))) signed short) -}
    functionType(vectorType(builtinType(nilQualifier(), signedType(longlongType())), 2), protoFunctionType([vectorType(builtinType(nilQualifier(), signedType(shortType())), 8)], false), nilQualifier()),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__builtin_ia32_roundps", builtinFunctionValueItem( {-  __attribute__((__vector_size__(4))) float(__attribute__((__vector_size__(4))) float, signed int) -}
    functionType(vectorType(builtinType(nilQualifier(), realType(floatType())), 4), protoFunctionType([vectorType(builtinType(nilQualifier(), realType(floatType())), 4), builtinType(nilQualifier(), signedType(intType()))], false), nilQualifier()),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__builtin_ia32_roundpd", builtinFunctionValueItem( {-  __attribute__((__vector_size__(2))) double(__attribute__((__vector_size__(2))) double, signed int) -}
    functionType(vectorType(builtinType(nilQualifier(), realType(doubleType())), 2), protoFunctionType([vectorType(builtinType(nilQualifier(), realType(doubleType())), 2), builtinType(nilQualifier(), signedType(intType()))], false), nilQualifier()),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__builtin_ia32_movntdqa", builtinFunctionValueItem( {-  __attribute__((__vector_size__(2))) signed long long(__attribute__((__vector_size__(2))) signed long long * ) -}
    functionType(vectorType(builtinType(nilQualifier(), signedType(longlongType())), 2), protoFunctionType([pointerType(nilQualifier(), vectorType(builtinType(nilQualifier(), signedType(longlongType())), 2))], false), nilQualifier()),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_ia32_ptestz128", builtinFunctionValueItem( {-  signed int(__attribute__((__vector_size__(2))) signed long long, __attribute__((__vector_size__(2))) signed long long) -}
    functionType(builtinType(nilQualifier(), signedType(intType())), protoFunctionType([vectorType(builtinType(nilQualifier(), signedType(longlongType())), 2), vectorType(builtinType(nilQualifier(), signedType(longlongType())), 2)], false), nilQualifier()),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__builtin_ia32_extrqi", builtinFunctionValueItem( {-  __attribute__((__vector_size__(2))) signed long long(__attribute__((__vector_size__(2))) signed long long, char, char) -}
    functionType(vectorType(builtinType(nilQualifier(), signedType(longlongType())), 2), protoFunctionType([vectorType(builtinType(nilQualifier(), signedType(longlongType())), 2), builtinType(nilQualifier(), signedType(charType())), builtinType(nilQualifier(), signedType(charType()))], false), nilQualifier()),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_ia32_extrq", builtinFunctionValueItem( {-  __attribute__((__vector_size__(2))) signed long long(__attribute__((__vector_size__(2))) signed long long, __attribute__((__vector_size__(16))) char) -}
    functionType(vectorType(builtinType(nilQualifier(), signedType(longlongType())), 2), protoFunctionType([vectorType(builtinType(nilQualifier(), signedType(longlongType())), 2), vectorType(builtinType(nilQualifier(), signedType(charType())), 16)], false), nilQualifier()),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__builtin_ia32_aesimc128", builtinFunctionValueItem( {-  __attribute__((__vector_size__(2))) signed long long(__attribute__((__vector_size__(2))) signed long long) -}
    functionType(vectorType(builtinType(nilQualifier(), signedType(longlongType())), 2), protoFunctionType([vectorType(builtinType(nilQualifier(), signedType(longlongType())), 2)], false), nilQualifier()),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_ia32_aeskeygenassist128", builtinFunctionValueItem( {-  __attribute__((__vector_size__(2))) signed long long(__attribute__((__vector_size__(2))) signed long long, char) -}
    functionType(vectorType(builtinType(nilQualifier(), signedType(longlongType())), 2), protoFunctionType([vectorType(builtinType(nilQualifier(), signedType(longlongType())), 2), builtinType(nilQualifier(), signedType(charType()))], false), nilQualifier()),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_ia32_pclmulqdq128", builtinFunctionValueItem( {-  __attribute__((__vector_size__(2))) signed long long(__attribute__((__vector_size__(2))) signed long long, __attribute__((__vector_size__(2))) signed long long, char) -}
    functionType(vectorType(builtinType(nilQualifier(), signedType(longlongType())), 2), protoFunctionType([vectorType(builtinType(nilQualifier(), signedType(longlongType())), 2), vectorType(builtinType(nilQualifier(), signedType(longlongType())), 2), builtinType(nilQualifier(), signedType(charType()))], false), nilQualifier()),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_ia32_addsubpd256", builtinFunctionValueItem( {-  __attribute__((__vector_size__(4))) double(__attribute__((__vector_size__(4))) double, __attribute__((__vector_size__(4))) double) -}
    functionType(vectorType(builtinType(nilQualifier(), realType(doubleType())), 4), protoFunctionType([vectorType(builtinType(nilQualifier(), realType(doubleType())), 4), vectorType(builtinType(nilQualifier(), realType(doubleType())), 4)], false), nilQualifier()),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__builtin_ia32_vpermilvarpd", builtinFunctionValueItem( {-  __attribute__((__vector_size__(2))) double(__attribute__((__vector_size__(2))) double, __attribute__((__vector_size__(2))) signed long long) -}
    functionType(vectorType(builtinType(nilQualifier(), realType(doubleType())), 2), protoFunctionType([vectorType(builtinType(nilQualifier(), realType(doubleType())), 2), vectorType(builtinType(nilQualifier(), signedType(longlongType())), 2)], false), nilQualifier()),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_ia32_vpermilvarps", builtinFunctionValueItem( {-  __attribute__((__vector_size__(4))) float(__attribute__((__vector_size__(4))) float, __attribute__((__vector_size__(4))) signed int) -}
    functionType(vectorType(builtinType(nilQualifier(), realType(floatType())), 4), protoFunctionType([vectorType(builtinType(nilQualifier(), realType(floatType())), 4), vectorType(builtinType(nilQualifier(), signedType(intType())), 4)], false), nilQualifier()),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_ia32_vpermilvarpd256", builtinFunctionValueItem( {-  __attribute__((__vector_size__(4))) double(__attribute__((__vector_size__(4))) double, __attribute__((__vector_size__(4))) signed long long) -}
    functionType(vectorType(builtinType(nilQualifier(), realType(doubleType())), 4), protoFunctionType([vectorType(builtinType(nilQualifier(), realType(doubleType())), 4), vectorType(builtinType(nilQualifier(), signedType(longlongType())), 4)], false), nilQualifier()),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_ia32_vpermilvarps256", builtinFunctionValueItem( {-  __attribute__((__vector_size__(8))) float(__attribute__((__vector_size__(8))) float, __attribute__((__vector_size__(8))) signed int) -}
    functionType(vectorType(builtinType(nilQualifier(), realType(floatType())), 8), protoFunctionType([vectorType(builtinType(nilQualifier(), realType(floatType())), 8), vectorType(builtinType(nilQualifier(), signedType(intType())), 8)], false), nilQualifier()),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_ia32_blendpd256", builtinFunctionValueItem( {-  __attribute__((__vector_size__(4))) double(__attribute__((__vector_size__(4))) double, __attribute__((__vector_size__(4))) double, signed int) -}
    functionType(vectorType(builtinType(nilQualifier(), realType(doubleType())), 4), protoFunctionType([vectorType(builtinType(nilQualifier(), realType(doubleType())), 4), vectorType(builtinType(nilQualifier(), realType(doubleType())), 4), builtinType(nilQualifier(), signedType(intType()))], false), nilQualifier()),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_ia32_blendps256", builtinFunctionValueItem( {-  __attribute__((__vector_size__(8))) float(__attribute__((__vector_size__(8))) float, __attribute__((__vector_size__(8))) float, signed int) -}
    functionType(vectorType(builtinType(nilQualifier(), realType(floatType())), 8), protoFunctionType([vectorType(builtinType(nilQualifier(), realType(floatType())), 8), vectorType(builtinType(nilQualifier(), realType(floatType())), 8), builtinType(nilQualifier(), signedType(intType()))], false), nilQualifier()),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_ia32_blendvpd256", builtinFunctionValueItem( {-  __attribute__((__vector_size__(4))) double(__attribute__((__vector_size__(4))) double, __attribute__((__vector_size__(4))) double, __attribute__((__vector_size__(4))) double) -}
    functionType(vectorType(builtinType(nilQualifier(), realType(doubleType())), 4), protoFunctionType([vectorType(builtinType(nilQualifier(), realType(doubleType())), 4), vectorType(builtinType(nilQualifier(), realType(doubleType())), 4), vectorType(builtinType(nilQualifier(), realType(doubleType())), 4)], false), nilQualifier()),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_ia32_blendvps256", builtinFunctionValueItem( {-  __attribute__((__vector_size__(8))) float(__attribute__((__vector_size__(8))) float, __attribute__((__vector_size__(8))) float, __attribute__((__vector_size__(8))) float) -}
    functionType(vectorType(builtinType(nilQualifier(), realType(floatType())), 8), protoFunctionType([vectorType(builtinType(nilQualifier(), realType(floatType())), 8), vectorType(builtinType(nilQualifier(), realType(floatType())), 8), vectorType(builtinType(nilQualifier(), realType(floatType())), 8)], false), nilQualifier()),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__builtin_ia32_cmppd256", builtinFunctionValueItem( {-  __attribute__((__vector_size__(4))) double(__attribute__((__vector_size__(4))) double, __attribute__((__vector_size__(4))) double, char) -}
    functionType(vectorType(builtinType(nilQualifier(), realType(doubleType())), 4), protoFunctionType([vectorType(builtinType(nilQualifier(), realType(doubleType())), 4), vectorType(builtinType(nilQualifier(), realType(doubleType())), 4), builtinType(nilQualifier(), signedType(charType()))], false), nilQualifier()),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_ia32_cmpps256", builtinFunctionValueItem( {-  __attribute__((__vector_size__(8))) float(__attribute__((__vector_size__(8))) float, __attribute__((__vector_size__(8))) float, char) -}
    functionType(vectorType(builtinType(nilQualifier(), realType(floatType())), 8), protoFunctionType([vectorType(builtinType(nilQualifier(), realType(floatType())), 8), vectorType(builtinType(nilQualifier(), realType(floatType())), 8), builtinType(nilQualifier(), signedType(charType()))], false), nilQualifier()),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_ia32_vextractf128_pd256", builtinFunctionValueItem( {-  __attribute__((__vector_size__(2))) double(__attribute__((__vector_size__(4))) double, char) -}
    functionType(vectorType(builtinType(nilQualifier(), realType(doubleType())), 2), protoFunctionType([vectorType(builtinType(nilQualifier(), realType(doubleType())), 4), builtinType(nilQualifier(), signedType(charType()))], false), nilQualifier()),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_ia32_vextractf128_ps256", builtinFunctionValueItem( {-  __attribute__((__vector_size__(4))) float(__attribute__((__vector_size__(8))) float, char) -}
    functionType(vectorType(builtinType(nilQualifier(), realType(floatType())), 4), protoFunctionType([vectorType(builtinType(nilQualifier(), realType(floatType())), 8), builtinType(nilQualifier(), signedType(charType()))], false), nilQualifier()),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_ia32_vextractf128_si256", builtinFunctionValueItem( {-  __attribute__((__vector_size__(4))) signed int(__attribute__((__vector_size__(8))) signed int, char) -}
    functionType(vectorType(builtinType(nilQualifier(), signedType(intType())), 4), protoFunctionType([vectorType(builtinType(nilQualifier(), signedType(intType())), 8), builtinType(nilQualifier(), signedType(charType()))], false), nilQualifier()),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_ia32_cvtdq2pd256", builtinFunctionValueItem( {-  __attribute__((__vector_size__(4))) double(__attribute__((__vector_size__(4))) signed int) -}
    functionType(vectorType(builtinType(nilQualifier(), realType(doubleType())), 4), protoFunctionType([vectorType(builtinType(nilQualifier(), signedType(intType())), 4)], false), nilQualifier()),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__builtin_ia32_cvtpd2ps256", builtinFunctionValueItem( {-  __attribute__((__vector_size__(4))) float(__attribute__((__vector_size__(4))) double) -}
    functionType(vectorType(builtinType(nilQualifier(), realType(floatType())), 4), protoFunctionType([vectorType(builtinType(nilQualifier(), realType(doubleType())), 4)], false), nilQualifier()),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__builtin_ia32_cvtps2pd256", builtinFunctionValueItem( {-  __attribute__((__vector_size__(4))) double(__attribute__((__vector_size__(4))) float) -}
    functionType(vectorType(builtinType(nilQualifier(), realType(doubleType())), 4), protoFunctionType([vectorType(builtinType(nilQualifier(), realType(floatType())), 4)], false), nilQualifier()),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_ia32_cvttpd2dq256", builtinFunctionValueItem( {-  __attribute__((__vector_size__(4))) signed int(__attribute__((__vector_size__(4))) double) -}
    functionType(vectorType(builtinType(nilQualifier(), signedType(intType())), 4), protoFunctionType([vectorType(builtinType(nilQualifier(), realType(doubleType())), 4)], false), nilQualifier()),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__builtin_ia32_vperm2f128_si256", builtinFunctionValueItem( {-  __attribute__((__vector_size__(8))) signed int(__attribute__((__vector_size__(8))) signed int, __attribute__((__vector_size__(8))) signed int, char) -}
    functionType(vectorType(builtinType(nilQualifier(), signedType(intType())), 8), protoFunctionType([vectorType(builtinType(nilQualifier(), signedType(intType())), 8), vectorType(builtinType(nilQualifier(), signedType(intType())), 8), builtinType(nilQualifier(), signedType(charType()))], false), nilQualifier()),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_ia32_vinsertf128_pd256", builtinFunctionValueItem( {-  __attribute__((__vector_size__(4))) double(__attribute__((__vector_size__(4))) double, __attribute__((__vector_size__(2))) double, char) -}
    functionType(vectorType(builtinType(nilQualifier(), realType(doubleType())), 4), protoFunctionType([vectorType(builtinType(nilQualifier(), realType(doubleType())), 4), vectorType(builtinType(nilQualifier(), realType(doubleType())), 2), builtinType(nilQualifier(), signedType(charType()))], false), nilQualifier()),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_ia32_vinsertf128_ps256", builtinFunctionValueItem( {-  __attribute__((__vector_size__(8))) float(__attribute__((__vector_size__(8))) float, __attribute__((__vector_size__(4))) float, char) -}
    functionType(vectorType(builtinType(nilQualifier(), realType(floatType())), 8), protoFunctionType([vectorType(builtinType(nilQualifier(), realType(floatType())), 8), vectorType(builtinType(nilQualifier(), realType(floatType())), 4), builtinType(nilQualifier(), signedType(charType()))], false), nilQualifier()),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_ia32_vinsertf128_si256", builtinFunctionValueItem( {-  __attribute__((__vector_size__(8))) signed int(__attribute__((__vector_size__(8))) signed int, __attribute__((__vector_size__(4))) signed int, char) -}
    functionType(vectorType(builtinType(nilQualifier(), signedType(intType())), 8), protoFunctionType([vectorType(builtinType(nilQualifier(), signedType(intType())), 8), vectorType(builtinType(nilQualifier(), signedType(intType())), 4), builtinType(nilQualifier(), signedType(charType()))], false), nilQualifier()),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_ia32_sqrtpd256", builtinFunctionValueItem( {-  __attribute__((__vector_size__(4))) double(__attribute__((__vector_size__(4))) double) -}
    functionType(vectorType(builtinType(nilQualifier(), realType(doubleType())), 4), protoFunctionType([vectorType(builtinType(nilQualifier(), realType(doubleType())), 4)], false), nilQualifier()),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__builtin_ia32_roundpd256", builtinFunctionValueItem( {-  __attribute__((__vector_size__(4))) double(__attribute__((__vector_size__(4))) double, signed int) -}
    functionType(vectorType(builtinType(nilQualifier(), realType(doubleType())), 4), protoFunctionType([vectorType(builtinType(nilQualifier(), realType(doubleType())), 4), builtinType(nilQualifier(), signedType(intType()))], false), nilQualifier()),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_ia32_roundps256", builtinFunctionValueItem( {-  __attribute__((__vector_size__(8))) float(__attribute__((__vector_size__(8))) float, signed int) -}
    functionType(vectorType(builtinType(nilQualifier(), realType(floatType())), 8), protoFunctionType([vectorType(builtinType(nilQualifier(), realType(floatType())), 8), builtinType(nilQualifier(), signedType(intType()))], false), nilQualifier()),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__builtin_ia32_vtestzpd256", builtinFunctionValueItem( {-  signed int(__attribute__((__vector_size__(4))) double, __attribute__((__vector_size__(4))) double) -}
    functionType(builtinType(nilQualifier(), signedType(intType())), protoFunctionType([vectorType(builtinType(nilQualifier(), realType(doubleType())), 4), vectorType(builtinType(nilQualifier(), realType(doubleType())), 4)], false), nilQualifier()),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__builtin_ia32_vtestzps256", builtinFunctionValueItem( {-  signed int(__attribute__((__vector_size__(8))) float, __attribute__((__vector_size__(8))) float) -}
    functionType(builtinType(nilQualifier(), signedType(intType())), protoFunctionType([vectorType(builtinType(nilQualifier(), realType(floatType())), 8), vectorType(builtinType(nilQualifier(), realType(floatType())), 8)], false), nilQualifier()),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__builtin_ia32_ptestz256", builtinFunctionValueItem( {-  signed int(__attribute__((__vector_size__(4))) signed long long, __attribute__((__vector_size__(4))) signed long long) -}
    functionType(builtinType(nilQualifier(), signedType(intType())), protoFunctionType([vectorType(builtinType(nilQualifier(), signedType(longlongType())), 4), vectorType(builtinType(nilQualifier(), signedType(longlongType())), 4)], false), nilQualifier()),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__builtin_ia32_movmskpd256", builtinFunctionValueItem( {-  signed int(__attribute__((__vector_size__(4))) double) -}
    functionType(builtinType(nilQualifier(), signedType(intType())), protoFunctionType([vectorType(builtinType(nilQualifier(), realType(doubleType())), 4)], false), nilQualifier()),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_ia32_movmskps256", builtinFunctionValueItem( {-  signed int(__attribute__((__vector_size__(8))) float) -}
    functionType(builtinType(nilQualifier(), signedType(intType())), protoFunctionType([vectorType(builtinType(nilQualifier(), realType(floatType())), 8)], false), nilQualifier()),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__builtin_ia32_vbroadcastss", builtinFunctionValueItem( {-  __attribute__((__vector_size__(4))) float(const float * ) -}
    functionType(vectorType(builtinType(nilQualifier(), realType(floatType())), 4), protoFunctionType([pointerType(nilQualifier(), builtinType(consQualifier(constQualifier(location=builtinLoc("host")), nilQualifier()), realType(floatType())))], false), nilQualifier()),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_ia32_vbroadcastsd256", builtinFunctionValueItem( {-  __attribute__((__vector_size__(4))) double(const double * ) -}
    functionType(vectorType(builtinType(nilQualifier(), realType(doubleType())), 4), protoFunctionType([pointerType(nilQualifier(), builtinType(consQualifier(constQualifier(location=builtinLoc("host")), nilQualifier()), realType(doubleType())))], false), nilQualifier()),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_ia32_vbroadcastss256", builtinFunctionValueItem( {-  __attribute__((__vector_size__(8))) float(const float * ) -}
    functionType(vectorType(builtinType(nilQualifier(), realType(floatType())), 8), protoFunctionType([pointerType(nilQualifier(), builtinType(consQualifier(constQualifier(location=builtinLoc("host")), nilQualifier()), realType(floatType())))], false), nilQualifier()),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_ia32_vbroadcastf128_pd256", builtinFunctionValueItem( {-  __attribute__((__vector_size__(4))) double(__attribute__((__vector_size__(2))) const double * ) -}
    functionType(vectorType(builtinType(nilQualifier(), realType(doubleType())), 4), protoFunctionType([pointerType(nilQualifier(), vectorType(builtinType(consQualifier(constQualifier(location=builtinLoc("host")), nilQualifier()), realType(doubleType())), 2))], false), nilQualifier()),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_ia32_vbroadcastf128_ps256", builtinFunctionValueItem( {-  __attribute__((__vector_size__(8))) float(__attribute__((__vector_size__(4))) const float * ) -}
    functionType(vectorType(builtinType(nilQualifier(), realType(floatType())), 8), protoFunctionType([pointerType(nilQualifier(), vectorType(builtinType(consQualifier(constQualifier(location=builtinLoc("host")), nilQualifier()), realType(floatType())), 4))], false), nilQualifier()),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_ia32_storeupd256", builtinFunctionValueItem( {-  void(double * , __attribute__((__vector_size__(4))) double) -}
    functionType(builtinType(nilQualifier(), voidType()), protoFunctionType([pointerType(nilQualifier(), builtinType(nilQualifier(), realType(doubleType()))), vectorType(builtinType(nilQualifier(), realType(doubleType())), 4)], false), nilQualifier()),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_ia32_storeups256", builtinFunctionValueItem( {-  void(float * , __attribute__((__vector_size__(8))) float) -}
    functionType(builtinType(nilQualifier(), voidType()), protoFunctionType([pointerType(nilQualifier(), builtinType(nilQualifier(), realType(floatType()))), vectorType(builtinType(nilQualifier(), realType(floatType())), 8)], false), nilQualifier()),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_ia32_storedqu256", builtinFunctionValueItem( {-  void(char * , __attribute__((__vector_size__(32))) char) -}
    functionType(builtinType(nilQualifier(), voidType()), protoFunctionType([pointerType(nilQualifier(), builtinType(nilQualifier(), signedType(charType()))), vectorType(builtinType(nilQualifier(), signedType(charType())), 32)], false), nilQualifier()),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_ia32_lddqu256", builtinFunctionValueItem( {-  __attribute__((__vector_size__(32))) char(const char * ) -}
    functionType(vectorType(builtinType(nilQualifier(), signedType(charType())), 32), protoFunctionType([pointerType(nilQualifier(), builtinType(consQualifier(constQualifier(location=builtinLoc("host")), nilQualifier()), signedType(charType())))], false), nilQualifier()),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_ia32_movntdq256", builtinFunctionValueItem( {-  void(__attribute__((__vector_size__(4))) signed long long * , __attribute__((__vector_size__(4))) signed long long) -}
    functionType(builtinType(nilQualifier(), voidType()), protoFunctionType([pointerType(nilQualifier(), vectorType(builtinType(nilQualifier(), signedType(longlongType())), 4)), vectorType(builtinType(nilQualifier(), signedType(longlongType())), 4)], false), nilQualifier()),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__builtin_ia32_maskloadpd", builtinFunctionValueItem( {-  __attribute__((__vector_size__(2))) double(__attribute__((__vector_size__(2))) const double * , __attribute__((__vector_size__(2))) double) -}
    functionType(vectorType(builtinType(nilQualifier(), realType(doubleType())), 2), protoFunctionType([pointerType(nilQualifier(), vectorType(builtinType(consQualifier(constQualifier(location=builtinLoc("host")), nilQualifier()), realType(doubleType())), 2)), vectorType(builtinType(nilQualifier(), realType(doubleType())), 2)], false), nilQualifier()),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_ia32_maskloadps", builtinFunctionValueItem( {-  __attribute__((__vector_size__(4))) float(__attribute__((__vector_size__(4))) const float * , __attribute__((__vector_size__(4))) float) -}
    functionType(vectorType(builtinType(nilQualifier(), realType(floatType())), 4), protoFunctionType([pointerType(nilQualifier(), vectorType(builtinType(consQualifier(constQualifier(location=builtinLoc("host")), nilQualifier()), realType(floatType())), 4)), vectorType(builtinType(nilQualifier(), realType(floatType())), 4)], false), nilQualifier()),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_ia32_maskloadpd256", builtinFunctionValueItem( {-  __attribute__((__vector_size__(4))) double(__attribute__((__vector_size__(4))) const double * , __attribute__((__vector_size__(4))) double) -}
    functionType(vectorType(builtinType(nilQualifier(), realType(doubleType())), 4), protoFunctionType([pointerType(nilQualifier(), vectorType(builtinType(consQualifier(constQualifier(location=builtinLoc("host")), nilQualifier()), realType(doubleType())), 4)), vectorType(builtinType(nilQualifier(), realType(doubleType())), 4)], false), nilQualifier()),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_ia32_maskloadps256", builtinFunctionValueItem( {-  __attribute__((__vector_size__(8))) float(__attribute__((__vector_size__(8))) const float * , __attribute__((__vector_size__(8))) float) -}
    functionType(vectorType(builtinType(nilQualifier(), realType(floatType())), 8), protoFunctionType([pointerType(nilQualifier(), vectorType(builtinType(consQualifier(constQualifier(location=builtinLoc("host")), nilQualifier()), realType(floatType())), 8)), vectorType(builtinType(nilQualifier(), realType(floatType())), 8)], false), nilQualifier()),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_ia32_maskstorepd", builtinFunctionValueItem( {-  void(__attribute__((__vector_size__(2))) double * , __attribute__((__vector_size__(2))) double, __attribute__((__vector_size__(2))) double) -}
    functionType(builtinType(nilQualifier(), voidType()), protoFunctionType([pointerType(nilQualifier(), vectorType(builtinType(nilQualifier(), realType(doubleType())), 2)), vectorType(builtinType(nilQualifier(), realType(doubleType())), 2), vectorType(builtinType(nilQualifier(), realType(doubleType())), 2)], false), nilQualifier()),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_ia32_maskstoreps", builtinFunctionValueItem( {-  void(__attribute__((__vector_size__(4))) float * , __attribute__((__vector_size__(4))) float, __attribute__((__vector_size__(4))) float) -}
    functionType(builtinType(nilQualifier(), voidType()), protoFunctionType([pointerType(nilQualifier(), vectorType(builtinType(nilQualifier(), realType(floatType())), 4)), vectorType(builtinType(nilQualifier(), realType(floatType())), 4), vectorType(builtinType(nilQualifier(), realType(floatType())), 4)], false), nilQualifier()),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_ia32_maskstorepd256", builtinFunctionValueItem( {-  void(__attribute__((__vector_size__(4))) double * , __attribute__((__vector_size__(4))) double, __attribute__((__vector_size__(4))) double) -}
    functionType(builtinType(nilQualifier(), voidType()), protoFunctionType([pointerType(nilQualifier(), vectorType(builtinType(nilQualifier(), realType(doubleType())), 4)), vectorType(builtinType(nilQualifier(), realType(doubleType())), 4), vectorType(builtinType(nilQualifier(), realType(doubleType())), 4)], false), nilQualifier()),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_ia32_maskstoreps256", builtinFunctionValueItem( {-  void(__attribute__((__vector_size__(8))) float * , __attribute__((__vector_size__(8))) float, __attribute__((__vector_size__(8))) float) -}
    functionType(builtinType(nilQualifier(), voidType()), protoFunctionType([pointerType(nilQualifier(), vectorType(builtinType(nilQualifier(), realType(floatType())), 8)), vectorType(builtinType(nilQualifier(), realType(floatType())), 8), vectorType(builtinType(nilQualifier(), realType(floatType())), 8)], false), nilQualifier()),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__builtin_ia32_packsswb256", builtinFunctionValueItem( {-  __attribute__((__vector_size__(32))) char(__attribute__((__vector_size__(16))) signed short, __attribute__((__vector_size__(16))) signed short) -}
    functionType(vectorType(builtinType(nilQualifier(), signedType(charType())), 32), protoFunctionType([vectorType(builtinType(nilQualifier(), signedType(shortType())), 16), vectorType(builtinType(nilQualifier(), signedType(shortType())), 16)], false), nilQualifier()),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_ia32_packssdw256", builtinFunctionValueItem( {-  __attribute__((__vector_size__(16))) signed short(__attribute__((__vector_size__(8))) signed int, __attribute__((__vector_size__(8))) signed int) -}
    functionType(vectorType(builtinType(nilQualifier(), signedType(shortType())), 16), protoFunctionType([vectorType(builtinType(nilQualifier(), signedType(intType())), 8), vectorType(builtinType(nilQualifier(), signedType(intType())), 8)], false), nilQualifier()),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__builtin_ia32_pmaddubsw256", builtinFunctionValueItem( {-  __attribute__((__vector_size__(16))) signed short(__attribute__((__vector_size__(32))) char, __attribute__((__vector_size__(32))) char) -}
    functionType(vectorType(builtinType(nilQualifier(), signedType(shortType())), 16), protoFunctionType([vectorType(builtinType(nilQualifier(), signedType(charType())), 32), vectorType(builtinType(nilQualifier(), signedType(charType())), 32)], false), nilQualifier()),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_ia32_pmaddwd256", builtinFunctionValueItem( {-  __attribute__((__vector_size__(8))) signed int(__attribute__((__vector_size__(16))) signed short, __attribute__((__vector_size__(16))) signed short) -}
    functionType(vectorType(builtinType(nilQualifier(), signedType(intType())), 8), protoFunctionType([vectorType(builtinType(nilQualifier(), signedType(shortType())), 16), vectorType(builtinType(nilQualifier(), signedType(shortType())), 16)], false), nilQualifier()),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__builtin_ia32_pmovsxbd256", builtinFunctionValueItem( {-  __attribute__((__vector_size__(8))) signed int(__attribute__((__vector_size__(16))) char) -}
    functionType(vectorType(builtinType(nilQualifier(), signedType(intType())), 8), protoFunctionType([vectorType(builtinType(nilQualifier(), signedType(charType())), 16)], false), nilQualifier()),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_ia32_pmovsxbq256", builtinFunctionValueItem( {-  __attribute__((__vector_size__(4))) signed long long(__attribute__((__vector_size__(16))) char) -}
    functionType(vectorType(builtinType(nilQualifier(), signedType(longlongType())), 4), protoFunctionType([vectorType(builtinType(nilQualifier(), signedType(charType())), 16)], false), nilQualifier()),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_ia32_pmovsxwd256", builtinFunctionValueItem( {-  __attribute__((__vector_size__(8))) signed int(__attribute__((__vector_size__(8))) signed short) -}
    functionType(vectorType(builtinType(nilQualifier(), signedType(intType())), 8), protoFunctionType([vectorType(builtinType(nilQualifier(), signedType(shortType())), 8)], false), nilQualifier()),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_ia32_pmovsxwq256", builtinFunctionValueItem( {-  __attribute__((__vector_size__(4))) signed long long(__attribute__((__vector_size__(8))) signed short) -}
    functionType(vectorType(builtinType(nilQualifier(), signedType(longlongType())), 4), protoFunctionType([vectorType(builtinType(nilQualifier(), signedType(shortType())), 8)], false), nilQualifier()),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_ia32_pmovsxdq256", builtinFunctionValueItem( {-  __attribute__((__vector_size__(4))) signed long long(__attribute__((__vector_size__(4))) signed int) -}
    functionType(vectorType(builtinType(nilQualifier(), signedType(longlongType())), 4), protoFunctionType([vectorType(builtinType(nilQualifier(), signedType(intType())), 4)], false), nilQualifier()),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__builtin_ia32_pmuldq256", builtinFunctionValueItem( {-  __attribute__((__vector_size__(4))) signed long long(__attribute__((__vector_size__(8))) signed int, __attribute__((__vector_size__(8))) signed int) -}
    functionType(vectorType(builtinType(nilQualifier(), signedType(longlongType())), 4), protoFunctionType([vectorType(builtinType(nilQualifier(), signedType(intType())), 8), vectorType(builtinType(nilQualifier(), signedType(intType())), 8)], false), nilQualifier()),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__builtin_ia32_psadbw256", builtinFunctionValueItem( {-  __attribute__((__vector_size__(4))) signed long long(__attribute__((__vector_size__(32))) char, __attribute__((__vector_size__(32))) char) -}
    functionType(vectorType(builtinType(nilQualifier(), signedType(longlongType())), 4), protoFunctionType([vectorType(builtinType(nilQualifier(), signedType(charType())), 32), vectorType(builtinType(nilQualifier(), signedType(charType())), 32)], false), nilQualifier()),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__builtin_ia32_pslldqi256", builtinFunctionValueItem( {-  __attribute__((__vector_size__(4))) signed long long(__attribute__((__vector_size__(4))) signed long long, signed int) -}
    functionType(vectorType(builtinType(nilQualifier(), signedType(longlongType())), 4), protoFunctionType([vectorType(builtinType(nilQualifier(), signedType(longlongType())), 4), builtinType(nilQualifier(), signedType(intType()))], false), nilQualifier()),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__builtin_ia32_psllw256", builtinFunctionValueItem( {-  __attribute__((__vector_size__(16))) signed short(__attribute__((__vector_size__(16))) signed short, __attribute__((__vector_size__(8))) signed short) -}
    functionType(vectorType(builtinType(nilQualifier(), signedType(shortType())), 16), protoFunctionType([vectorType(builtinType(nilQualifier(), signedType(shortType())), 16), vectorType(builtinType(nilQualifier(), signedType(shortType())), 8)], false), nilQualifier()),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__builtin_ia32_pslld256", builtinFunctionValueItem( {-  __attribute__((__vector_size__(8))) signed int(__attribute__((__vector_size__(8))) signed int, __attribute__((__vector_size__(4))) signed int) -}
    functionType(vectorType(builtinType(nilQualifier(), signedType(intType())), 8), protoFunctionType([vectorType(builtinType(nilQualifier(), signedType(intType())), 8), vectorType(builtinType(nilQualifier(), signedType(intType())), 4)], false), nilQualifier()),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__builtin_ia32_psllq256", builtinFunctionValueItem( {-  __attribute__((__vector_size__(4))) signed long long(__attribute__((__vector_size__(4))) signed long long, __attribute__((__vector_size__(2))) signed long long) -}
    functionType(vectorType(builtinType(nilQualifier(), signedType(longlongType())), 4), protoFunctionType([vectorType(builtinType(nilQualifier(), signedType(longlongType())), 4), vectorType(builtinType(nilQualifier(), signedType(longlongType())), 2)], false), nilQualifier()),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__builtin_ia32_movntdqa256", builtinFunctionValueItem( {-  __attribute__((__vector_size__(4))) signed long long(__attribute__((__vector_size__(4))) signed long long * ) -}
    functionType(vectorType(builtinType(nilQualifier(), signedType(longlongType())), 4), protoFunctionType([pointerType(nilQualifier(), vectorType(builtinType(nilQualifier(), signedType(longlongType())), 4))], false), nilQualifier()),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__builtin_ia32_vbroadcastss_ps256", builtinFunctionValueItem( {-  __attribute__((__vector_size__(8))) float(__attribute__((__vector_size__(4))) float) -}
    functionType(vectorType(builtinType(nilQualifier(), realType(floatType())), 8), protoFunctionType([vectorType(builtinType(nilQualifier(), realType(floatType())), 4)], false), nilQualifier()),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_ia32_vbroadcastsd_pd256", builtinFunctionValueItem( {-  __attribute__((__vector_size__(4))) double(__attribute__((__vector_size__(2))) double) -}
    functionType(vectorType(builtinType(nilQualifier(), realType(doubleType())), 4), protoFunctionType([vectorType(builtinType(nilQualifier(), realType(doubleType())), 2)], false), nilQualifier()),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_ia32_vbroadcastsi256", builtinFunctionValueItem( {-  __attribute__((__vector_size__(4))) signed long long(__attribute__((__vector_size__(2))) const signed long long * ) -}
    functionType(vectorType(builtinType(nilQualifier(), signedType(longlongType())), 4), protoFunctionType([pointerType(nilQualifier(), vectorType(builtinType(consQualifier(constQualifier(location=builtinLoc("host")), nilQualifier()), signedType(longlongType())), 2))], false), nilQualifier()),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_ia32_pblendd128", builtinFunctionValueItem( {-  __attribute__((__vector_size__(4))) signed int(__attribute__((__vector_size__(4))) signed int, __attribute__((__vector_size__(4))) signed int, signed int) -}
    functionType(vectorType(builtinType(nilQualifier(), signedType(intType())), 4), protoFunctionType([vectorType(builtinType(nilQualifier(), signedType(intType())), 4), vectorType(builtinType(nilQualifier(), signedType(intType())), 4), builtinType(nilQualifier(), signedType(intType()))], false), nilQualifier()),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_ia32_pblendd256", builtinFunctionValueItem( {-  __attribute__((__vector_size__(8))) signed int(__attribute__((__vector_size__(8))) signed int, __attribute__((__vector_size__(8))) signed int, signed int) -}
    functionType(vectorType(builtinType(nilQualifier(), signedType(intType())), 8), protoFunctionType([vectorType(builtinType(nilQualifier(), signedType(intType())), 8), vectorType(builtinType(nilQualifier(), signedType(intType())), 8), builtinType(nilQualifier(), signedType(intType()))], false), nilQualifier()),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_ia32_pbroadcastb256", builtinFunctionValueItem( {-  __attribute__((__vector_size__(32))) char(__attribute__((__vector_size__(16))) char) -}
    functionType(vectorType(builtinType(nilQualifier(), signedType(charType())), 32), protoFunctionType([vectorType(builtinType(nilQualifier(), signedType(charType())), 16)], false), nilQualifier()),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_ia32_pbroadcastw256", builtinFunctionValueItem( {-  __attribute__((__vector_size__(16))) signed short(__attribute__((__vector_size__(8))) signed short) -}
    functionType(vectorType(builtinType(nilQualifier(), signedType(shortType())), 16), protoFunctionType([vectorType(builtinType(nilQualifier(), signedType(shortType())), 8)], false), nilQualifier()),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_ia32_pbroadcastd256", builtinFunctionValueItem( {-  __attribute__((__vector_size__(8))) signed int(__attribute__((__vector_size__(4))) signed int) -}
    functionType(vectorType(builtinType(nilQualifier(), signedType(intType())), 8), protoFunctionType([vectorType(builtinType(nilQualifier(), signedType(intType())), 4)], false), nilQualifier()),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_ia32_pbroadcastq256", builtinFunctionValueItem( {-  __attribute__((__vector_size__(4))) signed long long(__attribute__((__vector_size__(2))) signed long long) -}
    functionType(vectorType(builtinType(nilQualifier(), signedType(longlongType())), 4), protoFunctionType([vectorType(builtinType(nilQualifier(), signedType(longlongType())), 2)], false), nilQualifier()),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__builtin_ia32_permti256", builtinFunctionValueItem( {-  __attribute__((__vector_size__(4))) signed long long(__attribute__((__vector_size__(4))) signed long long, __attribute__((__vector_size__(4))) signed long long, char) -}
    functionType(vectorType(builtinType(nilQualifier(), signedType(longlongType())), 4), protoFunctionType([vectorType(builtinType(nilQualifier(), signedType(longlongType())), 4), vectorType(builtinType(nilQualifier(), signedType(longlongType())), 4), builtinType(nilQualifier(), signedType(charType()))], false), nilQualifier()),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_ia32_extract128i256", builtinFunctionValueItem( {-  __attribute__((__vector_size__(2))) signed long long(__attribute__((__vector_size__(4))) signed long long, char) -}
    functionType(vectorType(builtinType(nilQualifier(), signedType(longlongType())), 2), protoFunctionType([vectorType(builtinType(nilQualifier(), signedType(longlongType())), 4), builtinType(nilQualifier(), signedType(charType()))], false), nilQualifier()),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_ia32_insert128i256", builtinFunctionValueItem( {-  __attribute__((__vector_size__(4))) signed long long(__attribute__((__vector_size__(4))) signed long long, __attribute__((__vector_size__(2))) signed long long, char) -}
    functionType(vectorType(builtinType(nilQualifier(), signedType(longlongType())), 4), protoFunctionType([vectorType(builtinType(nilQualifier(), signedType(longlongType())), 4), vectorType(builtinType(nilQualifier(), signedType(longlongType())), 2), builtinType(nilQualifier(), signedType(charType()))], false), nilQualifier()),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_ia32_maskloadd256", builtinFunctionValueItem( {-  __attribute__((__vector_size__(8))) signed int(__attribute__((__vector_size__(8))) const signed int * , __attribute__((__vector_size__(8))) signed int) -}
    functionType(vectorType(builtinType(nilQualifier(), signedType(intType())), 8), protoFunctionType([pointerType(nilQualifier(), vectorType(builtinType(consQualifier(constQualifier(location=builtinLoc("host")), nilQualifier()), signedType(intType())), 8)), vectorType(builtinType(nilQualifier(), signedType(intType())), 8)], false), nilQualifier()),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_ia32_maskloadq256", builtinFunctionValueItem( {-  __attribute__((__vector_size__(4))) signed long long(__attribute__((__vector_size__(4))) const signed long long * , __attribute__((__vector_size__(4))) signed long long) -}
    functionType(vectorType(builtinType(nilQualifier(), signedType(longlongType())), 4), protoFunctionType([pointerType(nilQualifier(), vectorType(builtinType(consQualifier(constQualifier(location=builtinLoc("host")), nilQualifier()), signedType(longlongType())), 4)), vectorType(builtinType(nilQualifier(), signedType(longlongType())), 4)], false), nilQualifier()),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_ia32_maskloadd", builtinFunctionValueItem( {-  __attribute__((__vector_size__(4))) signed int(__attribute__((__vector_size__(4))) const signed int * , __attribute__((__vector_size__(4))) signed int) -}
    functionType(vectorType(builtinType(nilQualifier(), signedType(intType())), 4), protoFunctionType([pointerType(nilQualifier(), vectorType(builtinType(consQualifier(constQualifier(location=builtinLoc("host")), nilQualifier()), signedType(intType())), 4)), vectorType(builtinType(nilQualifier(), signedType(intType())), 4)], false), nilQualifier()),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_ia32_maskloadq", builtinFunctionValueItem( {-  __attribute__((__vector_size__(2))) signed long long(__attribute__((__vector_size__(2))) const signed long long * , __attribute__((__vector_size__(2))) signed long long) -}
    functionType(vectorType(builtinType(nilQualifier(), signedType(longlongType())), 2), protoFunctionType([pointerType(nilQualifier(), vectorType(builtinType(consQualifier(constQualifier(location=builtinLoc("host")), nilQualifier()), signedType(longlongType())), 2)), vectorType(builtinType(nilQualifier(), signedType(longlongType())), 2)], false), nilQualifier()),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_ia32_maskstored256", builtinFunctionValueItem( {-  void(__attribute__((__vector_size__(8))) signed int * , __attribute__((__vector_size__(8))) signed int, __attribute__((__vector_size__(8))) signed int) -}
    functionType(builtinType(nilQualifier(), voidType()), protoFunctionType([pointerType(nilQualifier(), vectorType(builtinType(nilQualifier(), signedType(intType())), 8)), vectorType(builtinType(nilQualifier(), signedType(intType())), 8), vectorType(builtinType(nilQualifier(), signedType(intType())), 8)], false), nilQualifier()),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_ia32_maskstoreq256", builtinFunctionValueItem( {-  void(__attribute__((__vector_size__(4))) signed long long * , __attribute__((__vector_size__(4))) signed long long, __attribute__((__vector_size__(4))) signed long long) -}
    functionType(builtinType(nilQualifier(), voidType()), protoFunctionType([pointerType(nilQualifier(), vectorType(builtinType(nilQualifier(), signedType(longlongType())), 4)), vectorType(builtinType(nilQualifier(), signedType(longlongType())), 4), vectorType(builtinType(nilQualifier(), signedType(longlongType())), 4)], false), nilQualifier()),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_ia32_maskstored", builtinFunctionValueItem( {-  void(__attribute__((__vector_size__(4))) signed int * , __attribute__((__vector_size__(4))) signed int, __attribute__((__vector_size__(4))) signed int) -}
    functionType(builtinType(nilQualifier(), voidType()), protoFunctionType([pointerType(nilQualifier(), vectorType(builtinType(nilQualifier(), signedType(intType())), 4)), vectorType(builtinType(nilQualifier(), signedType(intType())), 4), vectorType(builtinType(nilQualifier(), signedType(intType())), 4)], false), nilQualifier()),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_ia32_maskstoreq", builtinFunctionValueItem( {-  void(__attribute__((__vector_size__(2))) signed long long * , __attribute__((__vector_size__(2))) signed long long, __attribute__((__vector_size__(2))) signed long long) -}
    functionType(builtinType(nilQualifier(), voidType()), protoFunctionType([pointerType(nilQualifier(), vectorType(builtinType(nilQualifier(), signedType(longlongType())), 2)), vectorType(builtinType(nilQualifier(), signedType(longlongType())), 2), vectorType(builtinType(nilQualifier(), signedType(longlongType())), 2)], false), nilQualifier()),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__builtin_ia32_psllv4di", builtinFunctionValueItem( {-  __attribute__((__vector_size__(4))) signed long long(__attribute__((__vector_size__(4))) signed long long, __attribute__((__vector_size__(4))) signed long long) -}
    functionType(vectorType(builtinType(nilQualifier(), signedType(longlongType())), 4), protoFunctionType([vectorType(builtinType(nilQualifier(), signedType(longlongType())), 4), vectorType(builtinType(nilQualifier(), signedType(longlongType())), 4)], false), nilQualifier()),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__builtin_ia32_gatherd_pd", builtinFunctionValueItem( {-  __attribute__((__vector_size__(2))) double(__attribute__((__vector_size__(2))) double, __attribute__((__vector_size__(2))) const double * , __attribute__((__vector_size__(4))) signed int, __attribute__((__vector_size__(2))) double, char) -}
    functionType(vectorType(builtinType(nilQualifier(), realType(doubleType())), 2), protoFunctionType([vectorType(builtinType(nilQualifier(), realType(doubleType())), 2), pointerType(nilQualifier(), vectorType(builtinType(consQualifier(constQualifier(location=builtinLoc("host")), nilQualifier()), realType(doubleType())), 2)), vectorType(builtinType(nilQualifier(), signedType(intType())), 4), vectorType(builtinType(nilQualifier(), realType(doubleType())), 2), builtinType(nilQualifier(), signedType(charType()))], false), nilQualifier()),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_ia32_gatherd_pd256", builtinFunctionValueItem( {-  __attribute__((__vector_size__(4))) double(__attribute__((__vector_size__(4))) double, __attribute__((__vector_size__(4))) const double * , __attribute__((__vector_size__(4))) signed int, __attribute__((__vector_size__(4))) double, char) -}
    functionType(vectorType(builtinType(nilQualifier(), realType(doubleType())), 4), protoFunctionType([vectorType(builtinType(nilQualifier(), realType(doubleType())), 4), pointerType(nilQualifier(), vectorType(builtinType(consQualifier(constQualifier(location=builtinLoc("host")), nilQualifier()), realType(doubleType())), 4)), vectorType(builtinType(nilQualifier(), signedType(intType())), 4), vectorType(builtinType(nilQualifier(), realType(doubleType())), 4), builtinType(nilQualifier(), signedType(charType()))], false), nilQualifier()),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_ia32_gatherq_pd", builtinFunctionValueItem( {-  __attribute__((__vector_size__(2))) double(__attribute__((__vector_size__(2))) double, __attribute__((__vector_size__(2))) const double * , __attribute__((__vector_size__(2))) signed long long, __attribute__((__vector_size__(2))) double, char) -}
    functionType(vectorType(builtinType(nilQualifier(), realType(doubleType())), 2), protoFunctionType([vectorType(builtinType(nilQualifier(), realType(doubleType())), 2), pointerType(nilQualifier(), vectorType(builtinType(consQualifier(constQualifier(location=builtinLoc("host")), nilQualifier()), realType(doubleType())), 2)), vectorType(builtinType(nilQualifier(), signedType(longlongType())), 2), vectorType(builtinType(nilQualifier(), realType(doubleType())), 2), builtinType(nilQualifier(), signedType(charType()))], false), nilQualifier()),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_ia32_gatherq_pd256", builtinFunctionValueItem( {-  __attribute__((__vector_size__(4))) double(__attribute__((__vector_size__(4))) double, __attribute__((__vector_size__(4))) const double * , __attribute__((__vector_size__(4))) signed long long, __attribute__((__vector_size__(4))) double, char) -}
    functionType(vectorType(builtinType(nilQualifier(), realType(doubleType())), 4), protoFunctionType([vectorType(builtinType(nilQualifier(), realType(doubleType())), 4), pointerType(nilQualifier(), vectorType(builtinType(consQualifier(constQualifier(location=builtinLoc("host")), nilQualifier()), realType(doubleType())), 4)), vectorType(builtinType(nilQualifier(), signedType(longlongType())), 4), vectorType(builtinType(nilQualifier(), realType(doubleType())), 4), builtinType(nilQualifier(), signedType(charType()))], false), nilQualifier()),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_ia32_gatherd_ps", builtinFunctionValueItem( {-  __attribute__((__vector_size__(4))) float(__attribute__((__vector_size__(4))) float, __attribute__((__vector_size__(4))) const float * , __attribute__((__vector_size__(4))) signed int, __attribute__((__vector_size__(4))) float, char) -}
    functionType(vectorType(builtinType(nilQualifier(), realType(floatType())), 4), protoFunctionType([vectorType(builtinType(nilQualifier(), realType(floatType())), 4), pointerType(nilQualifier(), vectorType(builtinType(consQualifier(constQualifier(location=builtinLoc("host")), nilQualifier()), realType(floatType())), 4)), vectorType(builtinType(nilQualifier(), signedType(intType())), 4), vectorType(builtinType(nilQualifier(), realType(floatType())), 4), builtinType(nilQualifier(), signedType(charType()))], false), nilQualifier()),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_ia32_gatherd_ps256", builtinFunctionValueItem( {-  __attribute__((__vector_size__(8))) float(__attribute__((__vector_size__(8))) float, __attribute__((__vector_size__(8))) const float * , __attribute__((__vector_size__(8))) signed int, __attribute__((__vector_size__(8))) float, char) -}
    functionType(vectorType(builtinType(nilQualifier(), realType(floatType())), 8), protoFunctionType([vectorType(builtinType(nilQualifier(), realType(floatType())), 8), pointerType(nilQualifier(), vectorType(builtinType(consQualifier(constQualifier(location=builtinLoc("host")), nilQualifier()), realType(floatType())), 8)), vectorType(builtinType(nilQualifier(), signedType(intType())), 8), vectorType(builtinType(nilQualifier(), realType(floatType())), 8), builtinType(nilQualifier(), signedType(charType()))], false), nilQualifier()),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_ia32_gatherq_ps", builtinFunctionValueItem( {-  __attribute__((__vector_size__(4))) float(__attribute__((__vector_size__(4))) float, __attribute__((__vector_size__(4))) const float * , __attribute__((__vector_size__(2))) signed long long, __attribute__((__vector_size__(4))) float, char) -}
    functionType(vectorType(builtinType(nilQualifier(), realType(floatType())), 4), protoFunctionType([vectorType(builtinType(nilQualifier(), realType(floatType())), 4), pointerType(nilQualifier(), vectorType(builtinType(consQualifier(constQualifier(location=builtinLoc("host")), nilQualifier()), realType(floatType())), 4)), vectorType(builtinType(nilQualifier(), signedType(longlongType())), 2), vectorType(builtinType(nilQualifier(), realType(floatType())), 4), builtinType(nilQualifier(), signedType(charType()))], false), nilQualifier()),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_ia32_gatherq_ps256", builtinFunctionValueItem( {-  __attribute__((__vector_size__(4))) float(__attribute__((__vector_size__(4))) float, __attribute__((__vector_size__(4))) const float * , __attribute__((__vector_size__(4))) signed long long, __attribute__((__vector_size__(4))) float, char) -}
    functionType(vectorType(builtinType(nilQualifier(), realType(floatType())), 4), protoFunctionType([vectorType(builtinType(nilQualifier(), realType(floatType())), 4), pointerType(nilQualifier(), vectorType(builtinType(consQualifier(constQualifier(location=builtinLoc("host")), nilQualifier()), realType(floatType())), 4)), vectorType(builtinType(nilQualifier(), signedType(longlongType())), 4), vectorType(builtinType(nilQualifier(), realType(floatType())), 4), builtinType(nilQualifier(), signedType(charType()))], false), nilQualifier()),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_ia32_gatherd_q", builtinFunctionValueItem( {-  __attribute__((__vector_size__(2))) signed long long(__attribute__((__vector_size__(2))) signed long long, __attribute__((__vector_size__(2))) const signed long long * , __attribute__((__vector_size__(4))) signed int, __attribute__((__vector_size__(2))) signed long long, char) -}
    functionType(vectorType(builtinType(nilQualifier(), signedType(longlongType())), 2), protoFunctionType([vectorType(builtinType(nilQualifier(), signedType(longlongType())), 2), pointerType(nilQualifier(), vectorType(builtinType(consQualifier(constQualifier(location=builtinLoc("host")), nilQualifier()), signedType(longlongType())), 2)), vectorType(builtinType(nilQualifier(), signedType(intType())), 4), vectorType(builtinType(nilQualifier(), signedType(longlongType())), 2), builtinType(nilQualifier(), signedType(charType()))], false), nilQualifier()),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_ia32_gatherd_q256", builtinFunctionValueItem( {-  __attribute__((__vector_size__(4))) signed long long(__attribute__((__vector_size__(4))) signed long long, __attribute__((__vector_size__(4))) const signed long long * , __attribute__((__vector_size__(4))) signed int, __attribute__((__vector_size__(4))) signed long long, char) -}
    functionType(vectorType(builtinType(nilQualifier(), signedType(longlongType())), 4), protoFunctionType([vectorType(builtinType(nilQualifier(), signedType(longlongType())), 4), pointerType(nilQualifier(), vectorType(builtinType(consQualifier(constQualifier(location=builtinLoc("host")), nilQualifier()), signedType(longlongType())), 4)), vectorType(builtinType(nilQualifier(), signedType(intType())), 4), vectorType(builtinType(nilQualifier(), signedType(longlongType())), 4), builtinType(nilQualifier(), signedType(charType()))], false), nilQualifier()),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_ia32_gatherq_q", builtinFunctionValueItem( {-  __attribute__((__vector_size__(2))) signed long long(__attribute__((__vector_size__(2))) signed long long, __attribute__((__vector_size__(2))) const signed long long * , __attribute__((__vector_size__(2))) signed long long, __attribute__((__vector_size__(2))) signed long long, char) -}
    functionType(vectorType(builtinType(nilQualifier(), signedType(longlongType())), 2), protoFunctionType([vectorType(builtinType(nilQualifier(), signedType(longlongType())), 2), pointerType(nilQualifier(), vectorType(builtinType(consQualifier(constQualifier(location=builtinLoc("host")), nilQualifier()), signedType(longlongType())), 2)), vectorType(builtinType(nilQualifier(), signedType(longlongType())), 2), vectorType(builtinType(nilQualifier(), signedType(longlongType())), 2), builtinType(nilQualifier(), signedType(charType()))], false), nilQualifier()),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_ia32_gatherq_q256", builtinFunctionValueItem( {-  __attribute__((__vector_size__(4))) signed long long(__attribute__((__vector_size__(4))) signed long long, __attribute__((__vector_size__(4))) const signed long long * , __attribute__((__vector_size__(4))) signed long long, __attribute__((__vector_size__(4))) signed long long, char) -}
    functionType(vectorType(builtinType(nilQualifier(), signedType(longlongType())), 4), protoFunctionType([vectorType(builtinType(nilQualifier(), signedType(longlongType())), 4), pointerType(nilQualifier(), vectorType(builtinType(consQualifier(constQualifier(location=builtinLoc("host")), nilQualifier()), signedType(longlongType())), 4)), vectorType(builtinType(nilQualifier(), signedType(longlongType())), 4), vectorType(builtinType(nilQualifier(), signedType(longlongType())), 4), builtinType(nilQualifier(), signedType(charType()))], false), nilQualifier()),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_ia32_gatherd_d", builtinFunctionValueItem( {-  __attribute__((__vector_size__(4))) signed int(__attribute__((__vector_size__(4))) signed int, __attribute__((__vector_size__(4))) const signed int * , __attribute__((__vector_size__(4))) signed int, __attribute__((__vector_size__(4))) signed int, char) -}
    functionType(vectorType(builtinType(nilQualifier(), signedType(intType())), 4), protoFunctionType([vectorType(builtinType(nilQualifier(), signedType(intType())), 4), pointerType(nilQualifier(), vectorType(builtinType(consQualifier(constQualifier(location=builtinLoc("host")), nilQualifier()), signedType(intType())), 4)), vectorType(builtinType(nilQualifier(), signedType(intType())), 4), vectorType(builtinType(nilQualifier(), signedType(intType())), 4), builtinType(nilQualifier(), signedType(charType()))], false), nilQualifier()),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_ia32_gatherd_d256", builtinFunctionValueItem( {-  __attribute__((__vector_size__(8))) signed int(__attribute__((__vector_size__(8))) signed int, __attribute__((__vector_size__(8))) const signed int * , __attribute__((__vector_size__(8))) signed int, __attribute__((__vector_size__(8))) signed int, char) -}
    functionType(vectorType(builtinType(nilQualifier(), signedType(intType())), 8), protoFunctionType([vectorType(builtinType(nilQualifier(), signedType(intType())), 8), pointerType(nilQualifier(), vectorType(builtinType(consQualifier(constQualifier(location=builtinLoc("host")), nilQualifier()), signedType(intType())), 8)), vectorType(builtinType(nilQualifier(), signedType(intType())), 8), vectorType(builtinType(nilQualifier(), signedType(intType())), 8), builtinType(nilQualifier(), signedType(charType()))], false), nilQualifier()),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_ia32_gatherq_d", builtinFunctionValueItem( {-  __attribute__((__vector_size__(4))) signed int(__attribute__((__vector_size__(4))) signed int, __attribute__((__vector_size__(4))) const signed int * , __attribute__((__vector_size__(2))) signed long long, __attribute__((__vector_size__(4))) signed int, char) -}
    functionType(vectorType(builtinType(nilQualifier(), signedType(intType())), 4), protoFunctionType([vectorType(builtinType(nilQualifier(), signedType(intType())), 4), pointerType(nilQualifier(), vectorType(builtinType(consQualifier(constQualifier(location=builtinLoc("host")), nilQualifier()), signedType(intType())), 4)), vectorType(builtinType(nilQualifier(), signedType(longlongType())), 2), vectorType(builtinType(nilQualifier(), signedType(intType())), 4), builtinType(nilQualifier(), signedType(charType()))], false), nilQualifier()),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_ia32_gatherq_d256", builtinFunctionValueItem( {-  __attribute__((__vector_size__(4))) signed int(__attribute__((__vector_size__(4))) signed int, __attribute__((__vector_size__(4))) const signed int * , __attribute__((__vector_size__(4))) signed long long, __attribute__((__vector_size__(4))) signed int, char) -}
    functionType(vectorType(builtinType(nilQualifier(), signedType(intType())), 4), protoFunctionType([vectorType(builtinType(nilQualifier(), signedType(intType())), 4), pointerType(nilQualifier(), vectorType(builtinType(consQualifier(constQualifier(location=builtinLoc("host")), nilQualifier()), signedType(intType())), 4)), vectorType(builtinType(nilQualifier(), signedType(longlongType())), 4), vectorType(builtinType(nilQualifier(), signedType(intType())), 4), builtinType(nilQualifier(), signedType(charType()))], false), nilQualifier()),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_ia32_vcvtps2ph", builtinFunctionValueItem( {-  __attribute__((__vector_size__(8))) signed short(__attribute__((__vector_size__(4))) float, signed int) -}
    functionType(vectorType(builtinType(nilQualifier(), signedType(shortType())), 8), protoFunctionType([vectorType(builtinType(nilQualifier(), realType(floatType())), 4), builtinType(nilQualifier(), signedType(intType()))], false), nilQualifier()),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_ia32_vcvtps2ph256", builtinFunctionValueItem( {-  __attribute__((__vector_size__(8))) signed short(__attribute__((__vector_size__(8))) float, signed int) -}
    functionType(vectorType(builtinType(nilQualifier(), signedType(shortType())), 8), protoFunctionType([vectorType(builtinType(nilQualifier(), realType(floatType())), 8), builtinType(nilQualifier(), signedType(intType()))], false), nilQualifier()),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_ia32_vcvtph2ps", builtinFunctionValueItem( {-  __attribute__((__vector_size__(4))) float(__attribute__((__vector_size__(8))) signed short) -}
    functionType(vectorType(builtinType(nilQualifier(), realType(floatType())), 4), protoFunctionType([vectorType(builtinType(nilQualifier(), signedType(shortType())), 8)], false), nilQualifier()),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_ia32_vcvtph2ps256", builtinFunctionValueItem( {-  __attribute__((__vector_size__(8))) float(__attribute__((__vector_size__(8))) signed short) -}
    functionType(vectorType(builtinType(nilQualifier(), realType(floatType())), 8), protoFunctionType([vectorType(builtinType(nilQualifier(), signedType(shortType())), 8)], false), nilQualifier()),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__builtin_ia32_rdrand64_step", builtinFunctionValueItem( {-  unsigned int(unsigned long long * ) -}
    functionType(builtinType(nilQualifier(), unsignedType(intType())), protoFunctionType([pointerType(nilQualifier(), builtinType(nilQualifier(), unsignedType(longlongType())))], false), nilQualifier()),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__builtin_ia32_vpmacssww", builtinFunctionValueItem( {-  __attribute__((__vector_size__(8))) signed short(__attribute__((__vector_size__(8))) signed short, __attribute__((__vector_size__(8))) signed short, __attribute__((__vector_size__(8))) signed short) -}
    functionType(vectorType(builtinType(nilQualifier(), signedType(shortType())), 8), protoFunctionType([vectorType(builtinType(nilQualifier(), signedType(shortType())), 8), vectorType(builtinType(nilQualifier(), signedType(shortType())), 8), vectorType(builtinType(nilQualifier(), signedType(shortType())), 8)], false), nilQualifier()),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__builtin_ia32_vpmacsswd", builtinFunctionValueItem( {-  __attribute__((__vector_size__(4))) signed int(__attribute__((__vector_size__(8))) signed short, __attribute__((__vector_size__(8))) signed short, __attribute__((__vector_size__(4))) signed int) -}
    functionType(vectorType(builtinType(nilQualifier(), signedType(intType())), 4), protoFunctionType([vectorType(builtinType(nilQualifier(), signedType(shortType())), 8), vectorType(builtinType(nilQualifier(), signedType(shortType())), 8), vectorType(builtinType(nilQualifier(), signedType(intType())), 4)], false), nilQualifier()),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__builtin_ia32_vpmacssdd", builtinFunctionValueItem( {-  __attribute__((__vector_size__(4))) signed int(__attribute__((__vector_size__(4))) signed int, __attribute__((__vector_size__(4))) signed int, __attribute__((__vector_size__(4))) signed int) -}
    functionType(vectorType(builtinType(nilQualifier(), signedType(intType())), 4), protoFunctionType([vectorType(builtinType(nilQualifier(), signedType(intType())), 4), vectorType(builtinType(nilQualifier(), signedType(intType())), 4), vectorType(builtinType(nilQualifier(), signedType(intType())), 4)], false), nilQualifier()),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__builtin_ia32_vpmacssdql", builtinFunctionValueItem( {-  __attribute__((__vector_size__(2))) signed long long(__attribute__((__vector_size__(4))) signed int, __attribute__((__vector_size__(4))) signed int, __attribute__((__vector_size__(2))) signed long long) -}
    functionType(vectorType(builtinType(nilQualifier(), signedType(longlongType())), 2), protoFunctionType([vectorType(builtinType(nilQualifier(), signedType(intType())), 4), vectorType(builtinType(nilQualifier(), signedType(intType())), 4), vectorType(builtinType(nilQualifier(), signedType(longlongType())), 2)], false), nilQualifier()),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__builtin_ia32_vpcmov", builtinFunctionValueItem( {-  __attribute__((__vector_size__(2))) signed long long(__attribute__((__vector_size__(2))) signed long long, __attribute__((__vector_size__(2))) signed long long, __attribute__((__vector_size__(2))) signed long long) -}
    functionType(vectorType(builtinType(nilQualifier(), signedType(longlongType())), 2), protoFunctionType([vectorType(builtinType(nilQualifier(), signedType(longlongType())), 2), vectorType(builtinType(nilQualifier(), signedType(longlongType())), 2), vectorType(builtinType(nilQualifier(), signedType(longlongType())), 2)], false), nilQualifier()),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_ia32_vpcmov_256", builtinFunctionValueItem( {-  __attribute__((__vector_size__(4))) signed long long(__attribute__((__vector_size__(4))) signed long long, __attribute__((__vector_size__(4))) signed long long, __attribute__((__vector_size__(4))) signed long long) -}
    functionType(vectorType(builtinType(nilQualifier(), signedType(longlongType())), 4), protoFunctionType([vectorType(builtinType(nilQualifier(), signedType(longlongType())), 4), vectorType(builtinType(nilQualifier(), signedType(longlongType())), 4), vectorType(builtinType(nilQualifier(), signedType(longlongType())), 4)], false), nilQualifier()),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__builtin_ia32_vprotdi", builtinFunctionValueItem( {-  __attribute__((__vector_size__(4))) signed int(__attribute__((__vector_size__(4))) signed int, char) -}
    functionType(vectorType(builtinType(nilQualifier(), signedType(intType())), 4), protoFunctionType([vectorType(builtinType(nilQualifier(), signedType(intType())), 4), builtinType(nilQualifier(), signedType(charType()))], false), nilQualifier()),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__builtin_ia32_vpcomuw", builtinFunctionValueItem( {-  __attribute__((__vector_size__(8))) signed short(__attribute__((__vector_size__(8))) signed short, __attribute__((__vector_size__(8))) signed short, char) -}
    functionType(vectorType(builtinType(nilQualifier(), signedType(shortType())), 8), protoFunctionType([vectorType(builtinType(nilQualifier(), signedType(shortType())), 8), vectorType(builtinType(nilQualifier(), signedType(shortType())), 8), builtinType(nilQualifier(), signedType(charType()))], false), nilQualifier()),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_ia32_vpcomud", builtinFunctionValueItem( {-  __attribute__((__vector_size__(4))) signed int(__attribute__((__vector_size__(4))) signed int, __attribute__((__vector_size__(4))) signed int, char) -}
    functionType(vectorType(builtinType(nilQualifier(), signedType(intType())), 4), protoFunctionType([vectorType(builtinType(nilQualifier(), signedType(intType())), 4), vectorType(builtinType(nilQualifier(), signedType(intType())), 4), builtinType(nilQualifier(), signedType(charType()))], false), nilQualifier()),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__builtin_ia32_vpermil2pd256", builtinFunctionValueItem( {-  __attribute__((__vector_size__(4))) double(__attribute__((__vector_size__(4))) double, __attribute__((__vector_size__(4))) double, __attribute__((__vector_size__(4))) signed long long, char) -}
    functionType(vectorType(builtinType(nilQualifier(), realType(doubleType())), 4), protoFunctionType([vectorType(builtinType(nilQualifier(), realType(doubleType())), 4), vectorType(builtinType(nilQualifier(), realType(doubleType())), 4), vectorType(builtinType(nilQualifier(), signedType(longlongType())), 4), builtinType(nilQualifier(), signedType(charType()))], false), nilQualifier()),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_ia32_vpermil2ps", builtinFunctionValueItem( {-  __attribute__((__vector_size__(4))) float(__attribute__((__vector_size__(4))) float, __attribute__((__vector_size__(4))) float, __attribute__((__vector_size__(4))) signed int, char) -}
    functionType(vectorType(builtinType(nilQualifier(), realType(floatType())), 4), protoFunctionType([vectorType(builtinType(nilQualifier(), realType(floatType())), 4), vectorType(builtinType(nilQualifier(), realType(floatType())), 4), vectorType(builtinType(nilQualifier(), signedType(intType())), 4), builtinType(nilQualifier(), signedType(charType()))], false), nilQualifier()),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_ia32_vpermil2ps256", builtinFunctionValueItem( {-  __attribute__((__vector_size__(8))) float(__attribute__((__vector_size__(8))) float, __attribute__((__vector_size__(8))) float, __attribute__((__vector_size__(8))) signed int, char) -}
    functionType(vectorType(builtinType(nilQualifier(), realType(floatType())), 8), protoFunctionType([vectorType(builtinType(nilQualifier(), realType(floatType())), 8), vectorType(builtinType(nilQualifier(), realType(floatType())), 8), vectorType(builtinType(nilQualifier(), signedType(intType())), 8), builtinType(nilQualifier(), signedType(charType()))], false), nilQualifier()),
    ordinaryFunctionHandler))];
