...
d <- [valueDef("__builtin_atan2", builtinFunctionValueItem( {-  double(double, double) -}
    functionType(builtinType(nilQualifier(), realType(doubleType())), protoFunctionType([builtinType(nilQualifier(), realType(doubleType())), builtinType(nilQualifier(), realType(doubleType()))], false)),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_atan2f", builtinFunctionValueItem( {-  float(float, float) -}
    functionType(builtinType(nilQualifier(), realType(floatType())), protoFunctionType([builtinType(nilQualifier(), realType(floatType())), builtinType(nilQualifier(), realType(floatType()))], false)),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_atan2l", builtinFunctionValueItem( {-  long double(long double, long double) -}
    functionType(builtinType(nilQualifier(), realType(longdoubleType())), protoFunctionType([builtinType(nilQualifier(), realType(longdoubleType())), builtinType(nilQualifier(), realType(longdoubleType()))], false)),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_abs", builtinFunctionValueItem( {-  signed int(signed int) -}
    functionType(builtinType(nilQualifier(), signedType(intType())), protoFunctionType([builtinType(nilQualifier(), signedType(intType()))], false)),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__builtin_fabs", builtinFunctionValueItem( {-  double(double) -}
    functionType(builtinType(nilQualifier(), realType(doubleType())), protoFunctionType([builtinType(nilQualifier(), realType(doubleType()))], false)),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_fabsf", builtinFunctionValueItem( {-  float(float) -}
    functionType(builtinType(nilQualifier(), realType(floatType())), protoFunctionType([builtinType(nilQualifier(), realType(floatType()))], false)),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_fabsl", builtinFunctionValueItem( {-  long double(long double) -}
    functionType(builtinType(nilQualifier(), realType(longdoubleType())), protoFunctionType([builtinType(nilQualifier(), realType(longdoubleType()))], false)),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__builtin_frexp", builtinFunctionValueItem( {-  double(double, signed int * ) -}
    functionType(builtinType(nilQualifier(), realType(doubleType())), protoFunctionType([builtinType(nilQualifier(), realType(doubleType())), pointerType(nilQualifier(), builtinType(nilQualifier(), signedType(intType())))], false)),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_frexpf", builtinFunctionValueItem( {-  float(float, signed int * ) -}
    functionType(builtinType(nilQualifier(), realType(floatType())), protoFunctionType([builtinType(nilQualifier(), realType(floatType())), pointerType(nilQualifier(), builtinType(nilQualifier(), signedType(intType())))], false)),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_frexpl", builtinFunctionValueItem( {-  long double(long double, signed int * ) -}
    functionType(builtinType(nilQualifier(), realType(longdoubleType())), protoFunctionType([builtinType(nilQualifier(), realType(longdoubleType())), pointerType(nilQualifier(), builtinType(nilQualifier(), signedType(intType())))], false)),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_huge_val", builtinFunctionValueItem( {-  double(void) -}
    functionType(builtinType(nilQualifier(), realType(doubleType())), protoFunctionType([], false)),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_huge_valf", builtinFunctionValueItem( {-  float(void) -}
    functionType(builtinType(nilQualifier(), realType(floatType())), protoFunctionType([], false)),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_huge_vall", builtinFunctionValueItem( {-  long double(void) -}
    functionType(builtinType(nilQualifier(), realType(longdoubleType())), protoFunctionType([], false)),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__builtin_labs", builtinFunctionValueItem( {-  signed long(signed long) -}
    functionType(builtinType(nilQualifier(), signedType(longType())), protoFunctionType([builtinType(nilQualifier(), signedType(longType()))], false)),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_llabs", builtinFunctionValueItem( {-  signed long long(signed long long) -}
    functionType(builtinType(nilQualifier(), signedType(longlongType())), protoFunctionType([builtinType(nilQualifier(), signedType(longlongType()))], false)),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_ldexp", builtinFunctionValueItem( {-  double(double, signed int) -}
    functionType(builtinType(nilQualifier(), realType(doubleType())), protoFunctionType([builtinType(nilQualifier(), realType(doubleType())), builtinType(nilQualifier(), signedType(intType()))], false)),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_ldexpf", builtinFunctionValueItem( {-  float(float, signed int) -}
    functionType(builtinType(nilQualifier(), realType(floatType())), protoFunctionType([builtinType(nilQualifier(), realType(floatType())), builtinType(nilQualifier(), signedType(intType()))], false)),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_ldexpl", builtinFunctionValueItem( {-  long double(long double, signed int) -}
    functionType(builtinType(nilQualifier(), realType(longdoubleType())), protoFunctionType([builtinType(nilQualifier(), realType(longdoubleType())), builtinType(nilQualifier(), signedType(intType()))], false)),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_modf", builtinFunctionValueItem( {-  double(double, double * ) -}
    functionType(builtinType(nilQualifier(), realType(doubleType())), protoFunctionType([builtinType(nilQualifier(), realType(doubleType())), pointerType(nilQualifier(), builtinType(nilQualifier(), realType(doubleType())))], false)),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_modff", builtinFunctionValueItem( {-  float(float, float * ) -}
    functionType(builtinType(nilQualifier(), realType(floatType())), protoFunctionType([builtinType(nilQualifier(), realType(floatType())), pointerType(nilQualifier(), builtinType(nilQualifier(), realType(floatType())))], false)),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_modfl", builtinFunctionValueItem( {-  long double(long double, long double * ) -}
    functionType(builtinType(nilQualifier(), realType(longdoubleType())), protoFunctionType([builtinType(nilQualifier(), realType(longdoubleType())), pointerType(nilQualifier(), builtinType(nilQualifier(), realType(longdoubleType())))], false)),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_nan", builtinFunctionValueItem( {-  double(const char * ) -}
    functionType(builtinType(nilQualifier(), realType(doubleType())), protoFunctionType([pointerType(nilQualifier(), builtinType(consQualifier(constQualifier(), nilQualifier()), signedType(charType())))], false)),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_nanf", builtinFunctionValueItem( {-  float(const char * ) -}
    functionType(builtinType(nilQualifier(), realType(floatType())), protoFunctionType([pointerType(nilQualifier(), builtinType(consQualifier(constQualifier(), nilQualifier()), signedType(charType())))], false)),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_nanl", builtinFunctionValueItem( {-  long double(const char * ) -}
    functionType(builtinType(nilQualifier(), realType(longdoubleType())), protoFunctionType([pointerType(nilQualifier(), builtinType(consQualifier(constQualifier(), nilQualifier()), signedType(charType())))], false)),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__builtin_fma", builtinFunctionValueItem( {-  double(double, double, double) -}
    functionType(builtinType(nilQualifier(), realType(doubleType())), protoFunctionType([builtinType(nilQualifier(), realType(doubleType())), builtinType(nilQualifier(), realType(doubleType())), builtinType(nilQualifier(), realType(doubleType()))], false)),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_fmaf", builtinFunctionValueItem( {-  float(float, float, float) -}
    functionType(builtinType(nilQualifier(), realType(floatType())), protoFunctionType([builtinType(nilQualifier(), realType(floatType())), builtinType(nilQualifier(), realType(floatType())), builtinType(nilQualifier(), realType(floatType()))], false)),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_fmal", builtinFunctionValueItem( {-  long double(long double, long double, long double) -}
    functionType(builtinType(nilQualifier(), realType(longdoubleType())), protoFunctionType([builtinType(nilQualifier(), realType(longdoubleType())), builtinType(nilQualifier(), realType(longdoubleType())), builtinType(nilQualifier(), realType(longdoubleType()))], false)),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__builtin_ilogb", builtinFunctionValueItem( {-  signed int(double) -}
    functionType(builtinType(nilQualifier(), signedType(intType())), protoFunctionType([builtinType(nilQualifier(), realType(doubleType()))], false)),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_ilogbf", builtinFunctionValueItem( {-  signed int(float) -}
    functionType(builtinType(nilQualifier(), signedType(intType())), protoFunctionType([builtinType(nilQualifier(), realType(floatType()))], false)),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_ilogbl", builtinFunctionValueItem( {-  signed int(long double) -}
    functionType(builtinType(nilQualifier(), signedType(intType())), protoFunctionType([builtinType(nilQualifier(), realType(longdoubleType()))], false)),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__builtin_llrint", builtinFunctionValueItem( {-  signed long long(double) -}
    functionType(builtinType(nilQualifier(), signedType(longlongType())), protoFunctionType([builtinType(nilQualifier(), realType(doubleType()))], false)),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_llrintf", builtinFunctionValueItem( {-  signed long long(float) -}
    functionType(builtinType(nilQualifier(), signedType(longlongType())), protoFunctionType([builtinType(nilQualifier(), realType(floatType()))], false)),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_llrintl", builtinFunctionValueItem( {-  signed long long(long double) -}
    functionType(builtinType(nilQualifier(), signedType(longlongType())), protoFunctionType([builtinType(nilQualifier(), realType(longdoubleType()))], false)),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__builtin_lrint", builtinFunctionValueItem( {-  signed long(double) -}
    functionType(builtinType(nilQualifier(), signedType(longType())), protoFunctionType([builtinType(nilQualifier(), realType(doubleType()))], false)),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_lrintf", builtinFunctionValueItem( {-  signed long(float) -}
    functionType(builtinType(nilQualifier(), signedType(longType())), protoFunctionType([builtinType(nilQualifier(), realType(floatType()))], false)),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_lrintl", builtinFunctionValueItem( {-  signed long(long double) -}
    functionType(builtinType(nilQualifier(), signedType(longType())), protoFunctionType([builtinType(nilQualifier(), realType(longdoubleType()))], false)),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__builtin_remquo", builtinFunctionValueItem( {-  double(double, double, signed int * ) -}
    functionType(builtinType(nilQualifier(), realType(doubleType())), protoFunctionType([builtinType(nilQualifier(), realType(doubleType())), builtinType(nilQualifier(), realType(doubleType())), pointerType(nilQualifier(), builtinType(nilQualifier(), signedType(intType())))], false)),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_remquof", builtinFunctionValueItem( {-  float(float, float, signed int * ) -}
    functionType(builtinType(nilQualifier(), realType(floatType())), protoFunctionType([builtinType(nilQualifier(), realType(floatType())), builtinType(nilQualifier(), realType(floatType())), pointerType(nilQualifier(), builtinType(nilQualifier(), signedType(intType())))], false)),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_remquol", builtinFunctionValueItem( {-  long double(long double, long double, signed int * ) -}
    functionType(builtinType(nilQualifier(), realType(longdoubleType())), protoFunctionType([builtinType(nilQualifier(), realType(longdoubleType())), builtinType(nilQualifier(), realType(longdoubleType())), pointerType(nilQualifier(), builtinType(nilQualifier(), signedType(intType())))], false)),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__builtin_scalbln", builtinFunctionValueItem( {-  double(double, signed long) -}
    functionType(builtinType(nilQualifier(), realType(doubleType())), protoFunctionType([builtinType(nilQualifier(), realType(doubleType())), builtinType(nilQualifier(), signedType(longType()))], false)),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_scalblnf", builtinFunctionValueItem( {-  float(float, signed long) -}
    functionType(builtinType(nilQualifier(), realType(floatType())), protoFunctionType([builtinType(nilQualifier(), realType(floatType())), builtinType(nilQualifier(), signedType(longType()))], false)),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_scalblnl", builtinFunctionValueItem( {-  long double(long double, signed long) -}
    functionType(builtinType(nilQualifier(), realType(longdoubleType())), protoFunctionType([builtinType(nilQualifier(), realType(longdoubleType())), builtinType(nilQualifier(), signedType(longType()))], false)),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__builtin_cabs", builtinFunctionValueItem( {-  double(_Complex double) -}
    functionType(builtinType(nilQualifier(), realType(doubleType())), protoFunctionType([builtinType(nilQualifier(), complexType(doubleType()))], false)),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_cabsf", builtinFunctionValueItem( {-  float(_Complex float) -}
    functionType(builtinType(nilQualifier(), realType(floatType())), protoFunctionType([builtinType(nilQualifier(), complexType(floatType()))], false)),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_cabsl", builtinFunctionValueItem( {-  long double(_Complex long double) -}
    functionType(builtinType(nilQualifier(), realType(longdoubleType())), protoFunctionType([builtinType(nilQualifier(), complexType(longdoubleType()))], false)),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_cacos", builtinFunctionValueItem( {-  _Complex double(_Complex double) -}
    functionType(builtinType(nilQualifier(), complexType(doubleType())), protoFunctionType([builtinType(nilQualifier(), complexType(doubleType()))], false)),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_cacosf", builtinFunctionValueItem( {-  _Complex float(_Complex float) -}
    functionType(builtinType(nilQualifier(), complexType(floatType())), protoFunctionType([builtinType(nilQualifier(), complexType(floatType()))], false)),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__builtin_cacoshl", builtinFunctionValueItem( {-  _Complex long double(_Complex long double) -}
    functionType(builtinType(nilQualifier(), complexType(longdoubleType())), protoFunctionType([builtinType(nilQualifier(), complexType(longdoubleType()))], false)),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__builtin_cpow", builtinFunctionValueItem( {-  _Complex double(_Complex double, _Complex double) -}
    functionType(builtinType(nilQualifier(), complexType(doubleType())), protoFunctionType([builtinType(nilQualifier(), complexType(doubleType())), builtinType(nilQualifier(), complexType(doubleType()))], false)),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_cpowf", builtinFunctionValueItem( {-  _Complex float(_Complex float, _Complex float) -}
    functionType(builtinType(nilQualifier(), complexType(floatType())), protoFunctionType([builtinType(nilQualifier(), complexType(floatType())), builtinType(nilQualifier(), complexType(floatType()))], false)),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_cpowl", builtinFunctionValueItem( {-  _Complex long double(_Complex long double, _Complex long double) -}
    functionType(builtinType(nilQualifier(), complexType(longdoubleType())), protoFunctionType([builtinType(nilQualifier(), complexType(longdoubleType())), builtinType(nilQualifier(), complexType(longdoubleType()))], false)),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__builtin_isgreater", builtinFunctionValueItem( {-  signed int(void) -}
    functionType(builtinType(nilQualifier(), signedType(intType())), protoFunctionType([], true)),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__builtin_fpclassify", builtinFunctionValueItem( {-  signed int(signed int, signed int, signed int, signed int, ...) -}
    functionType(builtinType(nilQualifier(), signedType(intType())), protoFunctionType([builtinType(nilQualifier(), signedType(intType())), builtinType(nilQualifier(), signedType(intType())), builtinType(nilQualifier(), signedType(intType())), builtinType(nilQualifier(), signedType(intType()))], true)),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__builtin_clzs", builtinFunctionValueItem( {-  signed int(unsigned short) -}
    functionType(builtinType(nilQualifier(), signedType(intType())), protoFunctionType([builtinType(nilQualifier(), unsignedType(shortType()))], false)),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_clz", builtinFunctionValueItem( {-  signed int(unsigned int) -}
    functionType(builtinType(nilQualifier(), signedType(intType())), protoFunctionType([builtinType(nilQualifier(), unsignedType(intType()))], false)),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_clzl", builtinFunctionValueItem( {-  signed int(unsigned long) -}
    functionType(builtinType(nilQualifier(), signedType(intType())), protoFunctionType([builtinType(nilQualifier(), unsignedType(longType()))], false)),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_clzll", builtinFunctionValueItem( {-  signed int(unsigned long long) -}
    functionType(builtinType(nilQualifier(), signedType(intType())), protoFunctionType([builtinType(nilQualifier(), unsignedType(longlongType()))], false)),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__builtin_ffsl", builtinFunctionValueItem( {-  signed int(signed long) -}
    functionType(builtinType(nilQualifier(), signedType(intType())), protoFunctionType([builtinType(nilQualifier(), signedType(longType()))], false)),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_ffsll", builtinFunctionValueItem( {-  signed int(signed long long) -}
    functionType(builtinType(nilQualifier(), signedType(intType())), protoFunctionType([builtinType(nilQualifier(), signedType(longlongType()))], false)),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__builtin_bswap16", builtinFunctionValueItem( {-  unsigned short(unsigned short) -}
    functionType(builtinType(nilQualifier(), unsignedType(shortType())), protoFunctionType([builtinType(nilQualifier(), unsignedType(shortType()))], false)),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_bswap32", builtinFunctionValueItem( {-  unsigned int(unsigned int) -}
    functionType(builtinType(nilQualifier(), unsignedType(intType())), protoFunctionType([builtinType(nilQualifier(), unsignedType(intType()))], false)),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_bswap64", builtinFunctionValueItem( {-  unsigned long long(unsigned long long) -}
    functionType(builtinType(nilQualifier(), unsignedType(longlongType())), protoFunctionType([builtinType(nilQualifier(), unsignedType(longlongType()))], false)),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__builtin_va_end", builtinFunctionValueItem( {-  void(void * ) -}
    functionType(builtinType(nilQualifier(), voidType()), protoFunctionType([pointerType(nilQualifier(), builtinType(nilQualifier(), voidType()))], false)),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_va_copy", builtinFunctionValueItem( {-  void(void * , void * ) -}
    functionType(builtinType(nilQualifier(), voidType()), protoFunctionType([pointerType(nilQualifier(), builtinType(nilQualifier(), voidType())), pointerType(nilQualifier(), builtinType(nilQualifier(), voidType()))], false)),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_stdarg_start", builtinFunctionValueItem( {-  void(void * , ...) -}
    functionType(builtinType(nilQualifier(), voidType()), protoFunctionType([pointerType(nilQualifier(), builtinType(nilQualifier(), voidType()))], true)),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_bcmp", builtinFunctionValueItem( {-  signed int(void * , void * , signed int) -}
    functionType(builtinType(nilQualifier(), signedType(intType())), protoFunctionType([pointerType(nilQualifier(), builtinType(nilQualifier(), voidType())), pointerType(nilQualifier(), builtinType(nilQualifier(), voidType())), builtinType(nilQualifier(), signedType(intType()))], false)),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_bcopy", builtinFunctionValueItem( {-  void(void * , void * , signed int) -}
    functionType(builtinType(nilQualifier(), voidType()), protoFunctionType([pointerType(nilQualifier(), builtinType(nilQualifier(), voidType())), pointerType(nilQualifier(), builtinType(nilQualifier(), voidType())), builtinType(nilQualifier(), signedType(intType()))], false)),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_bzero", builtinFunctionValueItem( {-  void(void * , signed int) -}
    functionType(builtinType(nilQualifier(), voidType()), protoFunctionType([pointerType(nilQualifier(), builtinType(nilQualifier(), voidType())), builtinType(nilQualifier(), signedType(intType()))], false)),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__builtin_memchr", builtinFunctionValueItem( {-  void * (const void * , signed int, signed int) -}
    functionType(pointerType(nilQualifier(), builtinType(nilQualifier(), voidType())), protoFunctionType([pointerType(nilQualifier(), builtinType(consQualifier(constQualifier(), nilQualifier()), voidType())), builtinType(nilQualifier(), signedType(intType())), builtinType(nilQualifier(), signedType(intType()))], false)),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_memcmp", builtinFunctionValueItem( {-  signed int(const void * , const void * , signed int) -}
    functionType(builtinType(nilQualifier(), signedType(intType())), protoFunctionType([pointerType(nilQualifier(), builtinType(consQualifier(constQualifier(), nilQualifier()), voidType())), pointerType(nilQualifier(), builtinType(consQualifier(constQualifier(), nilQualifier()), voidType())), builtinType(nilQualifier(), signedType(intType()))], false)),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_memcpy", builtinFunctionValueItem( {-  void * (void * , const void * , signed int) -}
    functionType(pointerType(nilQualifier(), builtinType(nilQualifier(), voidType())), protoFunctionType([pointerType(nilQualifier(), builtinType(nilQualifier(), voidType())), pointerType(nilQualifier(), builtinType(consQualifier(constQualifier(), nilQualifier()), voidType())), builtinType(nilQualifier(), signedType(intType()))], false)),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__builtin_memset", builtinFunctionValueItem( {-  void * (void * , signed int, signed int) -}
    functionType(pointerType(nilQualifier(), builtinType(nilQualifier(), voidType())), protoFunctionType([pointerType(nilQualifier(), builtinType(nilQualifier(), voidType())), builtinType(nilQualifier(), signedType(intType())), builtinType(nilQualifier(), signedType(intType()))], false)),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_printf", builtinFunctionValueItem( {-  signed int(const char * , ...) -}
    functionType(builtinType(nilQualifier(), signedType(intType())), protoFunctionType([pointerType(nilQualifier(), builtinType(consQualifier(constQualifier(), nilQualifier()), signedType(charType())))], true)),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_stpcpy", builtinFunctionValueItem( {-  char * (char * , const char * ) -}
    functionType(pointerType(nilQualifier(), builtinType(nilQualifier(), signedType(charType()))), protoFunctionType([pointerType(nilQualifier(), builtinType(nilQualifier(), signedType(charType()))), pointerType(nilQualifier(), builtinType(consQualifier(constQualifier(), nilQualifier()), signedType(charType())))], false)),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_stpncpy", builtinFunctionValueItem( {-  char * (char * , const char * , signed int) -}
    functionType(pointerType(nilQualifier(), builtinType(nilQualifier(), signedType(charType()))), protoFunctionType([pointerType(nilQualifier(), builtinType(nilQualifier(), signedType(charType()))), pointerType(nilQualifier(), builtinType(consQualifier(constQualifier(), nilQualifier()), signedType(charType()))), builtinType(nilQualifier(), signedType(intType()))], false)),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_strcasecmp", builtinFunctionValueItem( {-  signed int(const char * , const char * ) -}
    functionType(builtinType(nilQualifier(), signedType(intType())), protoFunctionType([pointerType(nilQualifier(), builtinType(consQualifier(constQualifier(), nilQualifier()), signedType(charType()))), pointerType(nilQualifier(), builtinType(consQualifier(constQualifier(), nilQualifier()), signedType(charType())))], false)),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__builtin_strchr", builtinFunctionValueItem( {-  char * (const char * , signed int) -}
    functionType(pointerType(nilQualifier(), builtinType(nilQualifier(), signedType(charType()))), protoFunctionType([pointerType(nilQualifier(), builtinType(consQualifier(constQualifier(), nilQualifier()), signedType(charType()))), builtinType(nilQualifier(), signedType(intType()))], false)),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__builtin_strdup", builtinFunctionValueItem( {-  char * (const char * ) -}
    functionType(pointerType(nilQualifier(), builtinType(nilQualifier(), signedType(charType()))), protoFunctionType([pointerType(nilQualifier(), builtinType(consQualifier(constQualifier(), nilQualifier()), signedType(charType())))], false)),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_strlen", builtinFunctionValueItem( {-  signed int(const char * ) -}
    functionType(builtinType(nilQualifier(), signedType(intType())), protoFunctionType([pointerType(nilQualifier(), builtinType(consQualifier(constQualifier(), nilQualifier()), signedType(charType())))], false)),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__builtin_strpbrk", builtinFunctionValueItem( {-  char * (const char * , const char * ) -}
    functionType(pointerType(nilQualifier(), builtinType(nilQualifier(), signedType(charType()))), protoFunctionType([pointerType(nilQualifier(), builtinType(consQualifier(constQualifier(), nilQualifier()), signedType(charType()))), pointerType(nilQualifier(), builtinType(consQualifier(constQualifier(), nilQualifier()), signedType(charType())))], false)),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__builtin_return_address", builtinFunctionValueItem( {-  void * (unsigned int) -}
    functionType(pointerType(nilQualifier(), builtinType(nilQualifier(), voidType())), protoFunctionType([builtinType(nilQualifier(), unsignedType(intType()))], false)),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_extract_return_addr", builtinFunctionValueItem( {-  void * (void * ) -}
    functionType(pointerType(nilQualifier(), builtinType(nilQualifier(), voidType())), protoFunctionType([pointerType(nilQualifier(), builtinType(nilQualifier(), voidType()))], false)),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__builtin_setjmp", builtinFunctionValueItem( {-  signed int(void *  * ) -}
    functionType(builtinType(nilQualifier(), signedType(intType())), protoFunctionType([pointerType(nilQualifier(), pointerType(nilQualifier(), builtinType(nilQualifier(), voidType())))], false)),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_longjmp", builtinFunctionValueItem( {-  void(void *  * , signed int) -}
    functionType(builtinType(nilQualifier(), voidType()), protoFunctionType([pointerType(nilQualifier(), pointerType(nilQualifier(), builtinType(nilQualifier(), voidType()))), builtinType(nilQualifier(), signedType(intType()))], false)),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__builtin_snprintf", builtinFunctionValueItem( {-  signed int(char * , signed int, const char * , ...) -}
    functionType(builtinType(nilQualifier(), signedType(intType())), protoFunctionType([pointerType(nilQualifier(), builtinType(nilQualifier(), signedType(charType()))), builtinType(nilQualifier(), signedType(intType())), pointerType(nilQualifier(), builtinType(consQualifier(constQualifier(), nilQualifier()), signedType(charType())))], true)),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_vsprintf", builtinFunctionValueItem( {-  signed int(char * , const char * , void) -}
    functionType(builtinType(nilQualifier(), signedType(intType())), protoFunctionType([pointerType(nilQualifier(), builtinType(nilQualifier(), signedType(charType()))), pointerType(nilQualifier(), builtinType(consQualifier(constQualifier(), nilQualifier()), signedType(charType()))), builtinType(nilQualifier(), voidType())], false)),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_vsnprintf", builtinFunctionValueItem( {-  signed int(char * , signed int, const char * , void) -}
    functionType(builtinType(nilQualifier(), signedType(intType())), protoFunctionType([pointerType(nilQualifier(), builtinType(nilQualifier(), signedType(charType()))), builtinType(nilQualifier(), signedType(intType())), pointerType(nilQualifier(), builtinType(consQualifier(constQualifier(), nilQualifier()), signedType(charType()))), builtinType(nilQualifier(), voidType())], false)),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_eh_return", builtinFunctionValueItem( {-  void(signed int, void * ) -}
    functionType(builtinType(nilQualifier(), voidType()), protoFunctionType([builtinType(nilQualifier(), signedType(intType())), pointerType(nilQualifier(), builtinType(nilQualifier(), voidType()))], false)),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__builtin_dwarf_cfa", builtinFunctionValueItem( {-  void * (void) -}
    functionType(pointerType(nilQualifier(), builtinType(nilQualifier(), voidType())), protoFunctionType([], false)),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__builtin_extend_pointer", builtinFunctionValueItem( {-  unsigned long long(void * ) -}
    functionType(builtinType(nilQualifier(), unsignedType(longlongType())), protoFunctionType([pointerType(nilQualifier(), builtinType(nilQualifier(), voidType()))], false)),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__builtin___memset_chk", builtinFunctionValueItem( {-  void * (void * , signed int, signed int, signed int) -}
    functionType(pointerType(nilQualifier(), builtinType(nilQualifier(), voidType())), protoFunctionType([pointerType(nilQualifier(), builtinType(nilQualifier(), voidType())), builtinType(nilQualifier(), signedType(intType())), builtinType(nilQualifier(), signedType(intType())), builtinType(nilQualifier(), signedType(intType()))], false)),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__builtin___printf_chk", builtinFunctionValueItem( {-  signed int(signed int, const char * , ...) -}
    functionType(builtinType(nilQualifier(), signedType(intType())), protoFunctionType([builtinType(nilQualifier(), signedType(intType())), pointerType(nilQualifier(), builtinType(consQualifier(constQualifier(), nilQualifier()), signedType(charType())))], true)),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__builtin___vprintf_chk", builtinFunctionValueItem( {-  signed int(signed int, const char * , void) -}
    functionType(builtinType(nilQualifier(), signedType(intType())), protoFunctionType([builtinType(nilQualifier(), signedType(intType())), pointerType(nilQualifier(), builtinType(consQualifier(constQualifier(), nilQualifier()), signedType(charType()))), builtinType(nilQualifier(), voidType())], false)),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_expect", builtinFunctionValueItem( {-  signed long(signed long, signed long) -}
    functionType(builtinType(nilQualifier(), signedType(longType())), protoFunctionType([builtinType(nilQualifier(), signedType(longType())), builtinType(nilQualifier(), signedType(longType()))], false)),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_prefetch", builtinFunctionValueItem( {-  void(const void * , ...) -}
    functionType(builtinType(nilQualifier(), voidType()), protoFunctionType([pointerType(nilQualifier(), builtinType(consQualifier(constQualifier(), nilQualifier()), voidType()))], true)),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_readcyclecounter", builtinFunctionValueItem( {-  unsigned long long(void) -}
    functionType(builtinType(nilQualifier(), unsignedType(longlongType())), protoFunctionType([], false)),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__builtin_shufflevector", builtinFunctionValueItem( {-  void(void) -}
    functionType(builtinType(nilQualifier(), voidType()), protoFunctionType([], true)),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_alloca", builtinFunctionValueItem( {-  void * (signed int) -}
    functionType(pointerType(nilQualifier(), builtinType(nilQualifier(), voidType())), protoFunctionType([builtinType(nilQualifier(), signedType(intType()))], false)),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__c11_atomic_thread_fence", builtinFunctionValueItem( {-  void(signed int) -}
    functionType(builtinType(nilQualifier(), voidType()), protoFunctionType([builtinType(nilQualifier(), signedType(intType()))], false)),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__atomic_test_and_set", builtinFunctionValueItem( {-  _Bool(volatile void * , signed int) -}
    functionType(builtinType(nilQualifier(), boolType()), protoFunctionType([pointerType(nilQualifier(), builtinType(consQualifier(volatileQualifier(), nilQualifier()), voidType())), builtinType(nilQualifier(), signedType(intType()))], false)),
    ordinaryFunctionHandler))];
d <- [valueDef("__atomic_clear", builtinFunctionValueItem( {-  void(volatile void * , signed int) -}
    functionType(builtinType(nilQualifier(), voidType()), protoFunctionType([pointerType(nilQualifier(), builtinType(consQualifier(volatileQualifier(), nilQualifier()), voidType())), builtinType(nilQualifier(), signedType(intType()))], false)),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__atomic_always_lock_free", builtinFunctionValueItem( {-  signed int(signed int, const volatile void * ) -}
    functionType(builtinType(nilQualifier(), signedType(intType())), protoFunctionType([builtinType(nilQualifier(), signedType(intType())), pointerType(nilQualifier(), builtinType(consQualifier(constQualifier(), consQualifier(volatileQualifier(), nilQualifier())), voidType()))], false)),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__sync_fetch_and_min", builtinFunctionValueItem( {-  signed int(volatile signed int * , signed int) -}
    functionType(builtinType(nilQualifier(), signedType(intType())), protoFunctionType([pointerType(nilQualifier(), builtinType(consQualifier(volatileQualifier(), nilQualifier()), signedType(intType()))), builtinType(nilQualifier(), signedType(intType()))], false)),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__sync_fetch_and_umin", builtinFunctionValueItem( {-  unsigned int(volatile unsigned int * , unsigned int) -}
    functionType(builtinType(nilQualifier(), unsignedType(intType())), protoFunctionType([pointerType(nilQualifier(), builtinType(consQualifier(volatileQualifier(), nilQualifier()), unsignedType(intType()))), builtinType(nilQualifier(), unsignedType(intType()))], false)),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__assume", builtinFunctionValueItem( {-  void(_Bool) -}
    functionType(builtinType(nilQualifier(), voidType()), protoFunctionType([builtinType(nilQualifier(), boolType())], false)),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__builtin_uadd_overflow", builtinFunctionValueItem( {-  _Bool(const unsigned int, const unsigned int, unsigned int * ) -}
    functionType(builtinType(nilQualifier(), boolType()), protoFunctionType([builtinType(consQualifier(constQualifier(), nilQualifier()), unsignedType(intType())), builtinType(consQualifier(constQualifier(), nilQualifier()), unsignedType(intType())), pointerType(nilQualifier(), builtinType(nilQualifier(), unsignedType(intType())))], false)),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_uaddl_overflow", builtinFunctionValueItem( {-  _Bool(const unsigned long, const unsigned long, unsigned long * ) -}
    functionType(builtinType(nilQualifier(), boolType()), protoFunctionType([builtinType(consQualifier(constQualifier(), nilQualifier()), unsignedType(longType())), builtinType(consQualifier(constQualifier(), nilQualifier()), unsignedType(longType())), pointerType(nilQualifier(), builtinType(nilQualifier(), unsignedType(longType())))], false)),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__builtin_sadd_overflow", builtinFunctionValueItem( {-  _Bool(const signed int, const signed int, signed int * ) -}
    functionType(builtinType(nilQualifier(), boolType()), protoFunctionType([builtinType(consQualifier(constQualifier(), nilQualifier()), signedType(intType())), builtinType(consQualifier(constQualifier(), nilQualifier()), signedType(intType())), pointerType(nilQualifier(), builtinType(nilQualifier(), signedType(intType())))], false)),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_saddl_overflow", builtinFunctionValueItem( {-  _Bool(const signed long, const signed long, signed long * ) -}
    functionType(builtinType(nilQualifier(), boolType()), protoFunctionType([builtinType(consQualifier(constQualifier(), nilQualifier()), signedType(longType())), builtinType(consQualifier(constQualifier(), nilQualifier()), signedType(longType())), pointerType(nilQualifier(), builtinType(nilQualifier(), signedType(longType())))], false)),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_saddll_overflow", builtinFunctionValueItem( {-  _Bool(const signed long long, const signed long long, signed long long * ) -}
    functionType(builtinType(nilQualifier(), boolType()), protoFunctionType([builtinType(consQualifier(constQualifier(), nilQualifier()), signedType(longlongType())), builtinType(consQualifier(constQualifier(), nilQualifier()), signedType(longlongType())), pointerType(nilQualifier(), builtinType(nilQualifier(), signedType(longlongType())))], false)),
    ordinaryFunctionHandler))];
