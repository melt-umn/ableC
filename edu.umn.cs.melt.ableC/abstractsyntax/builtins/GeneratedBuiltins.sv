...
d <- [valueDef("__builtin_atan2", builtinFunctionValueItem( {-  double(double, double) -}
    functionType(builtinType([], realType(doubleType())), protoFunctionType([builtinType([], realType(doubleType())), builtinType([], realType(doubleType()))], false)),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_atan2f", builtinFunctionValueItem( {-  float(float, float) -}
    functionType(builtinType([], realType(floatType())), protoFunctionType([builtinType([], realType(floatType())), builtinType([], realType(floatType()))], false)),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_atan2l", builtinFunctionValueItem( {-  long double(long double, long double) -}
    functionType(builtinType([], realType(longdoubleType())), protoFunctionType([builtinType([], realType(longdoubleType())), builtinType([], realType(longdoubleType()))], false)),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_abs", builtinFunctionValueItem( {-  signed int(signed int) -}
    functionType(builtinType([], signedType(intType())), protoFunctionType([builtinType([], signedType(intType()))], false)),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__builtin_fabs", builtinFunctionValueItem( {-  double(double) -}
    functionType(builtinType([], realType(doubleType())), protoFunctionType([builtinType([], realType(doubleType()))], false)),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_fabsf", builtinFunctionValueItem( {-  float(float) -}
    functionType(builtinType([], realType(floatType())), protoFunctionType([builtinType([], realType(floatType()))], false)),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_fabsl", builtinFunctionValueItem( {-  long double(long double) -}
    functionType(builtinType([], realType(longdoubleType())), protoFunctionType([builtinType([], realType(longdoubleType()))], false)),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__builtin_frexp", builtinFunctionValueItem( {-  double(double, signed int *) -}
    functionType(builtinType([], realType(doubleType())), protoFunctionType([builtinType([], realType(doubleType())), pointerType([], builtinType([], signedType(intType())))], false)),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_frexpf", builtinFunctionValueItem( {-  float(float, signed int *) -}
    functionType(builtinType([], realType(floatType())), protoFunctionType([builtinType([], realType(floatType())), pointerType([], builtinType([], signedType(intType())))], false)),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_frexpl", builtinFunctionValueItem( {-  long double(long double, signed int *) -}
    functionType(builtinType([], realType(longdoubleType())), protoFunctionType([builtinType([], realType(longdoubleType())), pointerType([], builtinType([], signedType(intType())))], false)),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_huge_val", builtinFunctionValueItem( {-  double(void) -}
    functionType(builtinType([], realType(doubleType())), protoFunctionType([], false)),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_huge_valf", builtinFunctionValueItem( {-  float(void) -}
    functionType(builtinType([], realType(floatType())), protoFunctionType([], false)),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_huge_vall", builtinFunctionValueItem( {-  long double(void) -}
    functionType(builtinType([], realType(longdoubleType())), protoFunctionType([], false)),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__builtin_labs", builtinFunctionValueItem( {-  signed long(signed long) -}
    functionType(builtinType([], signedType(longType())), protoFunctionType([builtinType([], signedType(longType()))], false)),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_llabs", builtinFunctionValueItem( {-  signed long long(signed long long) -}
    functionType(builtinType([], signedType(longlongType())), protoFunctionType([builtinType([], signedType(longlongType()))], false)),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_ldexp", builtinFunctionValueItem( {-  double(double, signed int) -}
    functionType(builtinType([], realType(doubleType())), protoFunctionType([builtinType([], realType(doubleType())), builtinType([], signedType(intType()))], false)),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_ldexpf", builtinFunctionValueItem( {-  float(float, signed int) -}
    functionType(builtinType([], realType(floatType())), protoFunctionType([builtinType([], realType(floatType())), builtinType([], signedType(intType()))], false)),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_ldexpl", builtinFunctionValueItem( {-  long double(long double, signed int) -}
    functionType(builtinType([], realType(longdoubleType())), protoFunctionType([builtinType([], realType(longdoubleType())), builtinType([], signedType(intType()))], false)),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_modf", builtinFunctionValueItem( {-  double(double, double *) -}
    functionType(builtinType([], realType(doubleType())), protoFunctionType([builtinType([], realType(doubleType())), pointerType([], builtinType([], realType(doubleType())))], false)),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_modff", builtinFunctionValueItem( {-  float(float, float *) -}
    functionType(builtinType([], realType(floatType())), protoFunctionType([builtinType([], realType(floatType())), pointerType([], builtinType([], realType(floatType())))], false)),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_modfl", builtinFunctionValueItem( {-  long double(long double, long double *) -}
    functionType(builtinType([], realType(longdoubleType())), protoFunctionType([builtinType([], realType(longdoubleType())), pointerType([], builtinType([], realType(longdoubleType())))], false)),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_nan", builtinFunctionValueItem( {-  double(const char *) -}
    functionType(builtinType([], realType(doubleType())), protoFunctionType([pointerType([], builtinType([constQualifier()], signedType(charType())))], false)),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_nanf", builtinFunctionValueItem( {-  float(const char *) -}
    functionType(builtinType([], realType(floatType())), protoFunctionType([pointerType([], builtinType([constQualifier()], signedType(charType())))], false)),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_nanl", builtinFunctionValueItem( {-  long double(const char *) -}
    functionType(builtinType([], realType(longdoubleType())), protoFunctionType([pointerType([], builtinType([constQualifier()], signedType(charType())))], false)),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__builtin_fma", builtinFunctionValueItem( {-  double(double, double, double) -}
    functionType(builtinType([], realType(doubleType())), protoFunctionType([builtinType([], realType(doubleType())), builtinType([], realType(doubleType())), builtinType([], realType(doubleType()))], false)),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_fmaf", builtinFunctionValueItem( {-  float(float, float, float) -}
    functionType(builtinType([], realType(floatType())), protoFunctionType([builtinType([], realType(floatType())), builtinType([], realType(floatType())), builtinType([], realType(floatType()))], false)),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_fmal", builtinFunctionValueItem( {-  long double(long double, long double, long double) -}
    functionType(builtinType([], realType(longdoubleType())), protoFunctionType([builtinType([], realType(longdoubleType())), builtinType([], realType(longdoubleType())), builtinType([], realType(longdoubleType()))], false)),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__builtin_ilogb", builtinFunctionValueItem( {-  signed int(double) -}
    functionType(builtinType([], signedType(intType())), protoFunctionType([builtinType([], realType(doubleType()))], false)),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_ilogbf", builtinFunctionValueItem( {-  signed int(float) -}
    functionType(builtinType([], signedType(intType())), protoFunctionType([builtinType([], realType(floatType()))], false)),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_ilogbl", builtinFunctionValueItem( {-  signed int(long double) -}
    functionType(builtinType([], signedType(intType())), protoFunctionType([builtinType([], realType(longdoubleType()))], false)),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__builtin_llrint", builtinFunctionValueItem( {-  signed long long(double) -}
    functionType(builtinType([], signedType(longlongType())), protoFunctionType([builtinType([], realType(doubleType()))], false)),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_llrintf", builtinFunctionValueItem( {-  signed long long(float) -}
    functionType(builtinType([], signedType(longlongType())), protoFunctionType([builtinType([], realType(floatType()))], false)),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_llrintl", builtinFunctionValueItem( {-  signed long long(long double) -}
    functionType(builtinType([], signedType(longlongType())), protoFunctionType([builtinType([], realType(longdoubleType()))], false)),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__builtin_lrint", builtinFunctionValueItem( {-  signed long(double) -}
    functionType(builtinType([], signedType(longType())), protoFunctionType([builtinType([], realType(doubleType()))], false)),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_lrintf", builtinFunctionValueItem( {-  signed long(float) -}
    functionType(builtinType([], signedType(longType())), protoFunctionType([builtinType([], realType(floatType()))], false)),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_lrintl", builtinFunctionValueItem( {-  signed long(long double) -}
    functionType(builtinType([], signedType(longType())), protoFunctionType([builtinType([], realType(longdoubleType()))], false)),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__builtin_remquo", builtinFunctionValueItem( {-  double(double, double, signed int *) -}
    functionType(builtinType([], realType(doubleType())), protoFunctionType([builtinType([], realType(doubleType())), builtinType([], realType(doubleType())), pointerType([], builtinType([], signedType(intType())))], false)),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_remquof", builtinFunctionValueItem( {-  float(float, float, signed int *) -}
    functionType(builtinType([], realType(floatType())), protoFunctionType([builtinType([], realType(floatType())), builtinType([], realType(floatType())), pointerType([], builtinType([], signedType(intType())))], false)),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_remquol", builtinFunctionValueItem( {-  long double(long double, long double, signed int *) -}
    functionType(builtinType([], realType(longdoubleType())), protoFunctionType([builtinType([], realType(longdoubleType())), builtinType([], realType(longdoubleType())), pointerType([], builtinType([], signedType(intType())))], false)),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__builtin_scalbln", builtinFunctionValueItem( {-  double(double, signed long) -}
    functionType(builtinType([], realType(doubleType())), protoFunctionType([builtinType([], realType(doubleType())), builtinType([], signedType(longType()))], false)),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_scalblnf", builtinFunctionValueItem( {-  float(float, signed long) -}
    functionType(builtinType([], realType(floatType())), protoFunctionType([builtinType([], realType(floatType())), builtinType([], signedType(longType()))], false)),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_scalblnl", builtinFunctionValueItem( {-  long double(long double, signed long) -}
    functionType(builtinType([], realType(longdoubleType())), protoFunctionType([builtinType([], realType(longdoubleType())), builtinType([], signedType(longType()))], false)),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__builtin_cabs", builtinFunctionValueItem( {-  double(_Complex double) -}
    functionType(builtinType([], realType(doubleType())), protoFunctionType([builtinType([], complexType(doubleType()))], false)),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_cabsf", builtinFunctionValueItem( {-  float(_Complex float) -}
    functionType(builtinType([], realType(floatType())), protoFunctionType([builtinType([], complexType(floatType()))], false)),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_cabsl", builtinFunctionValueItem( {-  long double(_Complex long double) -}
    functionType(builtinType([], realType(longdoubleType())), protoFunctionType([builtinType([], complexType(longdoubleType()))], false)),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_cacos", builtinFunctionValueItem( {-  _Complex double(_Complex double) -}
    functionType(builtinType([], complexType(doubleType())), protoFunctionType([builtinType([], complexType(doubleType()))], false)),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_cacosf", builtinFunctionValueItem( {-  _Complex float(_Complex float) -}
    functionType(builtinType([], complexType(floatType())), protoFunctionType([builtinType([], complexType(floatType()))], false)),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__builtin_cacoshl", builtinFunctionValueItem( {-  _Complex long double(_Complex long double) -}
    functionType(builtinType([], complexType(longdoubleType())), protoFunctionType([builtinType([], complexType(longdoubleType()))], false)),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__builtin_cpow", builtinFunctionValueItem( {-  _Complex double(_Complex double, _Complex double) -}
    functionType(builtinType([], complexType(doubleType())), protoFunctionType([builtinType([], complexType(doubleType())), builtinType([], complexType(doubleType()))], false)),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_cpowf", builtinFunctionValueItem( {-  _Complex float(_Complex float, _Complex float) -}
    functionType(builtinType([], complexType(floatType())), protoFunctionType([builtinType([], complexType(floatType())), builtinType([], complexType(floatType()))], false)),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_cpowl", builtinFunctionValueItem( {-  _Complex long double(_Complex long double, _Complex long double) -}
    functionType(builtinType([], complexType(longdoubleType())), protoFunctionType([builtinType([], complexType(longdoubleType())), builtinType([], complexType(longdoubleType()))], false)),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__builtin_isgreater", builtinFunctionValueItem( {-  signed int(void) -}
    functionType(builtinType([], signedType(intType())), protoFunctionType([], true)),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__builtin_fpclassify", builtinFunctionValueItem( {-  signed int(signed int, signed int, signed int, signed int, ...) -}
    functionType(builtinType([], signedType(intType())), protoFunctionType([builtinType([], signedType(intType())), builtinType([], signedType(intType())), builtinType([], signedType(intType())), builtinType([], signedType(intType()))], true)),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__builtin_clzs", builtinFunctionValueItem( {-  signed int(unsigned short) -}
    functionType(builtinType([], signedType(intType())), protoFunctionType([builtinType([], unsignedType(shortType()))], false)),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_clz", builtinFunctionValueItem( {-  signed int(unsigned int) -}
    functionType(builtinType([], signedType(intType())), protoFunctionType([builtinType([], unsignedType(intType()))], false)),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_clzl", builtinFunctionValueItem( {-  signed int(unsigned long) -}
    functionType(builtinType([], signedType(intType())), protoFunctionType([builtinType([], unsignedType(longType()))], false)),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_clzll", builtinFunctionValueItem( {-  signed int(unsigned long long) -}
    functionType(builtinType([], signedType(intType())), protoFunctionType([builtinType([], unsignedType(longlongType()))], false)),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__builtin_ffsl", builtinFunctionValueItem( {-  signed int(signed long) -}
    functionType(builtinType([], signedType(intType())), protoFunctionType([builtinType([], signedType(longType()))], false)),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_ffsll", builtinFunctionValueItem( {-  signed int(signed long long) -}
    functionType(builtinType([], signedType(intType())), protoFunctionType([builtinType([], signedType(longlongType()))], false)),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__builtin_bswap16", builtinFunctionValueItem( {-  unsigned short(unsigned short) -}
    functionType(builtinType([], unsignedType(shortType())), protoFunctionType([builtinType([], unsignedType(shortType()))], false)),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_bswap32", builtinFunctionValueItem( {-  unsigned int(unsigned int) -}
    functionType(builtinType([], unsignedType(intType())), protoFunctionType([builtinType([], unsignedType(intType()))], false)),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_bswap64", builtinFunctionValueItem( {-  unsigned long long(unsigned long long) -}
    functionType(builtinType([], unsignedType(longlongType())), protoFunctionType([builtinType([], unsignedType(longlongType()))], false)),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__builtin_va_end", builtinFunctionValueItem( {-  void(void *) -}
    functionType(builtinType([], voidType()), protoFunctionType([pointerType([], builtinType([], voidType()))], false)),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_va_copy", builtinFunctionValueItem( {-  void(void *, void *) -}
    functionType(builtinType([], voidType()), protoFunctionType([pointerType([], builtinType([], voidType())), pointerType([], builtinType([], voidType()))], false)),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_stdarg_start", builtinFunctionValueItem( {-  void(void *, ...) -}
    functionType(builtinType([], voidType()), protoFunctionType([pointerType([], builtinType([], voidType()))], true)),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_bcmp", builtinFunctionValueItem( {-  signed int(void *, void *, signed int) -}
    functionType(builtinType([], signedType(intType())), protoFunctionType([pointerType([], builtinType([], voidType())), pointerType([], builtinType([], voidType())), builtinType([], signedType(intType()))], false)),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_bcopy", builtinFunctionValueItem( {-  void(void *, void *, signed int) -}
    functionType(builtinType([], voidType()), protoFunctionType([pointerType([], builtinType([], voidType())), pointerType([], builtinType([], voidType())), builtinType([], signedType(intType()))], false)),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_bzero", builtinFunctionValueItem( {-  void(void *, signed int) -}
    functionType(builtinType([], voidType()), protoFunctionType([pointerType([], builtinType([], voidType())), builtinType([], signedType(intType()))], false)),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__builtin_memchr", builtinFunctionValueItem( {-  void *(const void *, signed int, signed int) -}
    functionType(pointerType([], builtinType([], voidType())), protoFunctionType([pointerType([], builtinType([constQualifier()], voidType())), builtinType([], signedType(intType())), builtinType([], signedType(intType()))], false)),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_memcmp", builtinFunctionValueItem( {-  signed int(const void *, const void *, signed int) -}
    functionType(builtinType([], signedType(intType())), protoFunctionType([pointerType([], builtinType([constQualifier()], voidType())), pointerType([], builtinType([constQualifier()], voidType())), builtinType([], signedType(intType()))], false)),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_memcpy", builtinFunctionValueItem( {-  void *(void *, const void *, signed int) -}
    functionType(pointerType([], builtinType([], voidType())), protoFunctionType([pointerType([], builtinType([], voidType())), pointerType([], builtinType([constQualifier()], voidType())), builtinType([], signedType(intType()))], false)),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__builtin_memset", builtinFunctionValueItem( {-  void *(void *, signed int, signed int) -}
    functionType(pointerType([], builtinType([], voidType())), protoFunctionType([pointerType([], builtinType([], voidType())), builtinType([], signedType(intType())), builtinType([], signedType(intType()))], false)),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_printf", builtinFunctionValueItem( {-  signed int(const char *, ...) -}
    functionType(builtinType([], signedType(intType())), protoFunctionType([pointerType([], builtinType([constQualifier()], signedType(charType())))], true)),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_stpcpy", builtinFunctionValueItem( {-  char *(char *, const char *) -}
    functionType(pointerType([], builtinType([], signedType(charType()))), protoFunctionType([pointerType([], builtinType([], signedType(charType()))), pointerType([], builtinType([constQualifier()], signedType(charType())))], false)),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_stpncpy", builtinFunctionValueItem( {-  char *(char *, const char *, signed int) -}
    functionType(pointerType([], builtinType([], signedType(charType()))), protoFunctionType([pointerType([], builtinType([], signedType(charType()))), pointerType([], builtinType([constQualifier()], signedType(charType()))), builtinType([], signedType(intType()))], false)),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_strcasecmp", builtinFunctionValueItem( {-  signed int(const char *, const char *) -}
    functionType(builtinType([], signedType(intType())), protoFunctionType([pointerType([], builtinType([constQualifier()], signedType(charType()))), pointerType([], builtinType([constQualifier()], signedType(charType())))], false)),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__builtin_strchr", builtinFunctionValueItem( {-  char *(const char *, signed int) -}
    functionType(pointerType([], builtinType([], signedType(charType()))), protoFunctionType([pointerType([], builtinType([constQualifier()], signedType(charType()))), builtinType([], signedType(intType()))], false)),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__builtin_strdup", builtinFunctionValueItem( {-  char *(const char *) -}
    functionType(pointerType([], builtinType([], signedType(charType()))), protoFunctionType([pointerType([], builtinType([constQualifier()], signedType(charType())))], false)),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_strlen", builtinFunctionValueItem( {-  signed int(const char *) -}
    functionType(builtinType([], signedType(intType())), protoFunctionType([pointerType([], builtinType([constQualifier()], signedType(charType())))], false)),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_strncasecmp", builtinFunctionValueItem( {-  signed int(const char *, const char *, signed int) -}
    functionType(builtinType([], signedType(intType())), protoFunctionType([pointerType([], builtinType([constQualifier()], signedType(charType()))), pointerType([], builtinType([constQualifier()], signedType(charType()))), builtinType([], signedType(intType()))], false)),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__builtin_strpbrk", builtinFunctionValueItem( {-  char *(const char *, const char *) -}
    functionType(pointerType([], builtinType([], signedType(charType()))), protoFunctionType([pointerType([], builtinType([constQualifier()], signedType(charType()))), pointerType([], builtinType([constQualifier()], signedType(charType())))], false)),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__builtin_return_address", builtinFunctionValueItem( {-  void *(unsigned int) -}
    functionType(pointerType([], builtinType([], voidType())), protoFunctionType([builtinType([], unsignedType(intType()))], false)),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_extract_return_addr", builtinFunctionValueItem( {-  void *(void *) -}
    functionType(pointerType([], builtinType([], voidType())), protoFunctionType([pointerType([], builtinType([], voidType()))], false)),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__builtin_setjmp", builtinFunctionValueItem( {-  signed int(void * *) -}
    functionType(builtinType([], signedType(intType())), protoFunctionType([pointerType([], pointerType([], builtinType([], voidType())))], false)),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_longjmp", builtinFunctionValueItem( {-  void(void * *, signed int) -}
    functionType(builtinType([], voidType()), protoFunctionType([pointerType([], pointerType([], builtinType([], voidType()))), builtinType([], signedType(intType()))], false)),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__builtin_snprintf", builtinFunctionValueItem( {-  signed int(char *, signed int, const char *, ...) -}
    functionType(builtinType([], signedType(intType())), protoFunctionType([pointerType([], builtinType([], signedType(charType()))), builtinType([], signedType(intType())), pointerType([], builtinType([constQualifier()], signedType(charType())))], true)),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_vsprintf", builtinFunctionValueItem( {-  signed int(char *, const char *, void) -}
    functionType(builtinType([], signedType(intType())), protoFunctionType([pointerType([], builtinType([], signedType(charType()))), pointerType([], builtinType([constQualifier()], signedType(charType()))), builtinType([], voidType())], false)),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_vsnprintf", builtinFunctionValueItem( {-  signed int(char *, signed int, const char *, void) -}
    functionType(builtinType([], signedType(intType())), protoFunctionType([pointerType([], builtinType([], signedType(charType()))), builtinType([], signedType(intType())), pointerType([], builtinType([constQualifier()], signedType(charType()))), builtinType([], voidType())], false)),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_eh_return", builtinFunctionValueItem( {-  void(signed int, void *) -}
    functionType(builtinType([], voidType()), protoFunctionType([builtinType([], signedType(intType())), pointerType([], builtinType([], voidType()))], false)),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__builtin_dwarf_cfa", builtinFunctionValueItem( {-  void *(void) -}
    functionType(pointerType([], builtinType([], voidType())), protoFunctionType([], false)),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__builtin_extend_pointer", builtinFunctionValueItem( {-  unsigned long long(void *) -}
    functionType(builtinType([], unsignedType(longlongType())), protoFunctionType([pointerType([], builtinType([], voidType()))], false)),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__builtin___memcpy_chk", builtinFunctionValueItem( {-  void *(void *, const void *, signed int, signed int) -}
    functionType(pointerType([], builtinType([], voidType())), protoFunctionType([pointerType([], builtinType([], voidType())), pointerType([], builtinType([constQualifier()], voidType())), builtinType([], signedType(intType())), builtinType([], signedType(intType()))], false)),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin___memccpy_chk", builtinFunctionValueItem( {-  void *(void *, const void *, signed int, signed int, signed int) -}
    functionType(pointerType([], builtinType([], voidType())), protoFunctionType([pointerType([], builtinType([], voidType())), pointerType([], builtinType([constQualifier()], voidType())), builtinType([], signedType(intType())), builtinType([], signedType(intType())), builtinType([], signedType(intType()))], false)),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__builtin___memset_chk", builtinFunctionValueItem( {-  void *(void *, signed int, signed int, signed int) -}
    functionType(pointerType([], builtinType([], voidType())), protoFunctionType([pointerType([], builtinType([], voidType())), builtinType([], signedType(intType())), builtinType([], signedType(intType())), builtinType([], signedType(intType()))], false)),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__builtin___strlcat_chk", builtinFunctionValueItem( {-  signed int(char *, const char *, signed int, signed int) -}
    functionType(builtinType([], signedType(intType())), protoFunctionType([pointerType([], builtinType([], signedType(charType()))), pointerType([], builtinType([constQualifier()], signedType(charType()))), builtinType([], signedType(intType())), builtinType([], signedType(intType()))], false)),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__builtin___strncat_chk", builtinFunctionValueItem( {-  char *(char *, const char *, signed int, signed int) -}
    functionType(pointerType([], builtinType([], signedType(charType()))), protoFunctionType([pointerType([], builtinType([], signedType(charType()))), pointerType([], builtinType([constQualifier()], signedType(charType()))), builtinType([], signedType(intType())), builtinType([], signedType(intType()))], false)),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__builtin___snprintf_chk", builtinFunctionValueItem( {-  signed int(char *, signed int, signed int, signed int, const char *, ...) -}
    functionType(builtinType([], signedType(intType())), protoFunctionType([pointerType([], builtinType([], signedType(charType()))), builtinType([], signedType(intType())), builtinType([], signedType(intType())), builtinType([], signedType(intType())), pointerType([], builtinType([constQualifier()], signedType(charType())))], true)),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin___sprintf_chk", builtinFunctionValueItem( {-  signed int(char *, signed int, signed int, const char *, ...) -}
    functionType(builtinType([], signedType(intType())), protoFunctionType([pointerType([], builtinType([], signedType(charType()))), builtinType([], signedType(intType())), builtinType([], signedType(intType())), pointerType([], builtinType([constQualifier()], signedType(charType())))], true)),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin___vsnprintf_chk", builtinFunctionValueItem( {-  signed int(char *, signed int, signed int, signed int, const char *, void) -}
    functionType(builtinType([], signedType(intType())), protoFunctionType([pointerType([], builtinType([], signedType(charType()))), builtinType([], signedType(intType())), builtinType([], signedType(intType())), builtinType([], signedType(intType())), pointerType([], builtinType([constQualifier()], signedType(charType()))), builtinType([], voidType())], false)),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin___vsprintf_chk", builtinFunctionValueItem( {-  signed int(char *, signed int, signed int, const char *, void) -}
    functionType(builtinType([], signedType(intType())), protoFunctionType([pointerType([], builtinType([], signedType(charType()))), builtinType([], signedType(intType())), builtinType([], signedType(intType())), pointerType([], builtinType([constQualifier()], signedType(charType()))), builtinType([], voidType())], false)),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__builtin___printf_chk", builtinFunctionValueItem( {-  signed int(signed int, const char *, ...) -}
    functionType(builtinType([], signedType(intType())), protoFunctionType([builtinType([], signedType(intType())), pointerType([], builtinType([constQualifier()], signedType(charType())))], true)),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__builtin___vprintf_chk", builtinFunctionValueItem( {-  signed int(signed int, const char *, void) -}
    functionType(builtinType([], signedType(intType())), protoFunctionType([builtinType([], signedType(intType())), pointerType([], builtinType([constQualifier()], signedType(charType()))), builtinType([], voidType())], false)),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_expect", builtinFunctionValueItem( {-  signed long(signed long, signed long) -}
    functionType(builtinType([], signedType(longType())), protoFunctionType([builtinType([], signedType(longType())), builtinType([], signedType(longType()))], false)),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_prefetch", builtinFunctionValueItem( {-  void(const void *, ...) -}
    functionType(builtinType([], voidType()), protoFunctionType([pointerType([], builtinType([constQualifier()], voidType()))], true)),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_readcyclecounter", builtinFunctionValueItem( {-  unsigned long long(void) -}
    functionType(builtinType([], unsignedType(longlongType())), protoFunctionType([], false)),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__builtin_shufflevector", builtinFunctionValueItem( {-  void(void) -}
    functionType(builtinType([], voidType()), protoFunctionType([], true)),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_alloca", builtinFunctionValueItem( {-  void *(signed int) -}
    functionType(pointerType([], builtinType([], voidType())), protoFunctionType([builtinType([], signedType(intType()))], false)),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__c11_atomic_thread_fence", builtinFunctionValueItem( {-  void(signed int) -}
    functionType(builtinType([], voidType()), protoFunctionType([builtinType([], signedType(intType()))], false)),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__atomic_test_and_set", builtinFunctionValueItem( {-  _Bool(volatile void *, signed int) -}
    functionType(builtinType([], boolType()), protoFunctionType([pointerType([], builtinType([volatileQualifier()], voidType())), builtinType([], signedType(intType()))], false)),
    ordinaryFunctionHandler))];
d <- [valueDef("__atomic_clear", builtinFunctionValueItem( {-  void(volatile void *, signed int) -}
    functionType(builtinType([], voidType()), protoFunctionType([pointerType([], builtinType([volatileQualifier()], voidType())), builtinType([], signedType(intType()))], false)),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__atomic_always_lock_free", builtinFunctionValueItem( {-  signed int(signed int, const volatile void *) -}
    functionType(builtinType([], signedType(intType())), protoFunctionType([builtinType([], signedType(intType())), pointerType([], builtinType([constQualifier(), volatileQualifier()], voidType()))], false)),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__sync_fetch_and_min", builtinFunctionValueItem( {-  signed int(volatile signed int *, signed int) -}
    functionType(builtinType([], signedType(intType())), protoFunctionType([pointerType([], builtinType([volatileQualifier()], signedType(intType()))), builtinType([], signedType(intType()))], false)),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__sync_fetch_and_umin", builtinFunctionValueItem( {-  unsigned int(volatile unsigned int *, unsigned int) -}
    functionType(builtinType([], unsignedType(intType())), protoFunctionType([pointerType([], builtinType([volatileQualifier()], unsignedType(intType()))), builtinType([], unsignedType(intType()))], false)),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__assume", builtinFunctionValueItem( {-  void(_Bool) -}
    functionType(builtinType([], voidType()), protoFunctionType([builtinType([], boolType())], false)),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__builtin_addcb", builtinFunctionValueItem( {-  unsigned char(const unsigned char, const unsigned char, const unsigned char, unsigned char *) -}
    functionType(builtinType([], unsignedType(charType())), protoFunctionType([builtinType([constQualifier()], unsignedType(charType())), builtinType([constQualifier()], unsignedType(charType())), builtinType([constQualifier()], unsignedType(charType())), pointerType([], builtinType([], unsignedType(charType())))], false)),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_addcs", builtinFunctionValueItem( {-  unsigned short(const unsigned short, const unsigned short, const unsigned short, unsigned short *) -}
    functionType(builtinType([], unsignedType(shortType())), protoFunctionType([builtinType([constQualifier()], unsignedType(shortType())), builtinType([constQualifier()], unsignedType(shortType())), builtinType([constQualifier()], unsignedType(shortType())), pointerType([], builtinType([], unsignedType(shortType())))], false)),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_addc", builtinFunctionValueItem( {-  unsigned int(const unsigned int, const unsigned int, const unsigned int, unsigned int *) -}
    functionType(builtinType([], unsignedType(intType())), protoFunctionType([builtinType([constQualifier()], unsignedType(intType())), builtinType([constQualifier()], unsignedType(intType())), builtinType([constQualifier()], unsignedType(intType())), pointerType([], builtinType([], unsignedType(intType())))], false)),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_addcl", builtinFunctionValueItem( {-  unsigned long(const unsigned long, const unsigned long, const unsigned long, unsigned long *) -}
    functionType(builtinType([], unsignedType(longType())), protoFunctionType([builtinType([constQualifier()], unsignedType(longType())), builtinType([constQualifier()], unsignedType(longType())), builtinType([constQualifier()], unsignedType(longType())), pointerType([], builtinType([], unsignedType(longType())))], false)),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_addcll", builtinFunctionValueItem( {-  unsigned long long(const unsigned long long, const unsigned long long, const unsigned long long, unsigned long long *) -}
    functionType(builtinType([], unsignedType(longlongType())), protoFunctionType([builtinType([constQualifier()], unsignedType(longlongType())), builtinType([constQualifier()], unsignedType(longlongType())), builtinType([constQualifier()], unsignedType(longlongType())), pointerType([], builtinType([], unsignedType(longlongType())))], false)),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__builtin_uadd_overflow", builtinFunctionValueItem( {-  _Bool(const unsigned int, const unsigned int, unsigned int *) -}
    functionType(builtinType([], boolType()), protoFunctionType([builtinType([constQualifier()], unsignedType(intType())), builtinType([constQualifier()], unsignedType(intType())), pointerType([], builtinType([], unsignedType(intType())))], false)),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_uaddl_overflow", builtinFunctionValueItem( {-  _Bool(const unsigned long, const unsigned long, unsigned long *) -}
    functionType(builtinType([], boolType()), protoFunctionType([builtinType([constQualifier()], unsignedType(longType())), builtinType([constQualifier()], unsignedType(longType())), pointerType([], builtinType([], unsignedType(longType())))], false)),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_uaddll_overflow", builtinFunctionValueItem( {-  _Bool(const unsigned long long, const unsigned long long, unsigned long long *) -}
    functionType(builtinType([], boolType()), protoFunctionType([builtinType([constQualifier()], unsignedType(longlongType())), builtinType([constQualifier()], unsignedType(longlongType())), pointerType([], builtinType([], unsignedType(longlongType())))], false)),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__builtin_sadd_overflow", builtinFunctionValueItem( {-  _Bool(const signed int, const signed int, signed int *) -}
    functionType(builtinType([], boolType()), protoFunctionType([builtinType([constQualifier()], signedType(intType())), builtinType([constQualifier()], signedType(intType())), pointerType([], builtinType([], signedType(intType())))], false)),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_saddl_overflow", builtinFunctionValueItem( {-  _Bool(const signed long, const signed long, signed long *) -}
    functionType(builtinType([], boolType()), protoFunctionType([builtinType([constQualifier()], signedType(longType())), builtinType([constQualifier()], signedType(longType())), pointerType([], builtinType([], signedType(longType())))], false)),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_saddll_overflow", builtinFunctionValueItem( {-  _Bool(const signed long long, const signed long long, signed long long *) -}
    functionType(builtinType([], boolType()), protoFunctionType([builtinType([constQualifier()], signedType(longlongType())), builtinType([constQualifier()], signedType(longlongType())), pointerType([], builtinType([], signedType(longlongType())))], false)),
    ordinaryFunctionHandler))];
