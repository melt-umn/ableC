...
extern size_t tag_pack (uint32_t id, uint8_t *out); // AbleC change: seems missing from original testcase
extern size_t prefixed_message_pack (const ProtobufCMessage *message, uint8_t *out); // AbleC change
