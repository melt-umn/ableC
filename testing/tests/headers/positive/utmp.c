...
extern void login (__const struct utmp *__entry) __attribute__ ((__nothrow__ , __leaf__));


extern int logout (__const char *__ut_line) __attribute__ ((__nothrow__ , __leaf__));


extern void logwtmp (__const char *__ut_line, __const char *__ut_name,
       __const char *__ut_host) __attribute__ ((__nothrow__ , __leaf__));
...
extern int utmpname (__const char *__file) __attribute__ ((__nothrow__ , __leaf__));
...
extern struct utmp *getutid (__const struct utmp *__id) __attribute__ ((__nothrow__ , __leaf__));



extern struct utmp *getutline (__const struct utmp *__line) __attribute__ ((__nothrow__ , __leaf__));


extern struct utmp *pututline (__const struct utmp *__utmp_ptr) __attribute__ ((__nothrow__ , __leaf__));
# 95 "utmp.c"
