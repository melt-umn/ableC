...
extern int lio_listio (int __mode,
         struct aiocb *__const __list[__restrict],
         int __nent, struct sigevent *__restrict __sig)
  __attribute__ ((__nothrow__ , __leaf__)) __attribute__ ((__nonnull__ (2)));


extern int aio_error (__const struct aiocb *__aiocbp) __attribute__ ((__nothrow__ , __leaf__)) __attribute__ ((__nonnull__ (1)));
