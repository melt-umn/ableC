...
d <- [valueDef("__builtin_nan", builtinFunctionValueItem( {-  double(const char * ) -}
    functionType(builtinType(nilQualifier(), realType(doubleType())), protoFunctionType([pointerType(nilQualifier(), builtinType(consQualifier(constQualifier(location=builtinLoc("host")), nilQualifier()), signedType(charType())))], false), nilQualifier()),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_nanf", builtinFunctionValueItem( {-  float(const char * ) -}
    functionType(builtinType(nilQualifier(), realType(floatType())), protoFunctionType([pointerType(nilQualifier(), builtinType(consQualifier(constQualifier(location=builtinLoc("host")), nilQualifier()), signedType(charType())))], false), nilQualifier()),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_nanl", builtinFunctionValueItem( {-  long double(const char * ) -}
    functionType(builtinType(nilQualifier(), realType(longdoubleType())), protoFunctionType([pointerType(nilQualifier(), builtinType(consQualifier(constQualifier(location=builtinLoc("host")), nilQualifier()), signedType(charType())))], false), nilQualifier()),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__builtin_memchr", builtinFunctionValueItem( {-  void * (const void * , signed int, signed int) -}
    functionType(pointerType(nilQualifier(), builtinType(nilQualifier(), voidType())), protoFunctionType([pointerType(nilQualifier(), builtinType(consQualifier(constQualifier(location=builtinLoc("host")), nilQualifier()), voidType())), builtinType(nilQualifier(), signedType(intType())), builtinType(nilQualifier(), signedType(intType()))], false), nilQualifier()),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_memcmp", builtinFunctionValueItem( {-  signed int(const void * , const void * , signed int) -}
    functionType(builtinType(nilQualifier(), signedType(intType())), protoFunctionType([pointerType(nilQualifier(), builtinType(consQualifier(constQualifier(location=builtinLoc("host")), nilQualifier()), voidType())), pointerType(nilQualifier(), builtinType(consQualifier(constQualifier(location=builtinLoc("host")), nilQualifier()), voidType())), builtinType(nilQualifier(), signedType(intType()))], false), nilQualifier()),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__builtin_printf", builtinFunctionValueItem( {-  signed int(const char * , ...) -}
    functionType(builtinType(nilQualifier(), signedType(intType())), protoFunctionType([pointerType(nilQualifier(), builtinType(consQualifier(constQualifier(location=builtinLoc("host")), nilQualifier()), signedType(charType())))], true), nilQualifier()),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_stpcpy", builtinFunctionValueItem( {-  char * (char * , const char * ) -}
    functionType(pointerType(nilQualifier(), builtinType(nilQualifier(), signedType(charType()))), protoFunctionType([pointerType(nilQualifier(), builtinType(nilQualifier(), signedType(charType()))), pointerType(nilQualifier(), builtinType(consQualifier(constQualifier(location=builtinLoc("host")), nilQualifier()), signedType(charType())))], false), nilQualifier()),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_stpncpy", builtinFunctionValueItem( {-  char * (char * , const char * , signed int) -}
    functionType(pointerType(nilQualifier(), builtinType(nilQualifier(), signedType(charType()))), protoFunctionType([pointerType(nilQualifier(), builtinType(nilQualifier(), signedType(charType()))), pointerType(nilQualifier(), builtinType(consQualifier(constQualifier(location=builtinLoc("host")), nilQualifier()), signedType(charType()))), builtinType(nilQualifier(), signedType(intType()))], false), nilQualifier()),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_strcasecmp", builtinFunctionValueItem( {-  signed int(const char * , const char * ) -}
    functionType(builtinType(nilQualifier(), signedType(intType())), protoFunctionType([pointerType(nilQualifier(), builtinType(consQualifier(constQualifier(location=builtinLoc("host")), nilQualifier()), signedType(charType()))), pointerType(nilQualifier(), builtinType(consQualifier(constQualifier(location=builtinLoc("host")), nilQualifier()), signedType(charType())))], false), nilQualifier()),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__builtin_strchr", builtinFunctionValueItem( {-  char * (const char * , signed int) -}
    functionType(pointerType(nilQualifier(), builtinType(nilQualifier(), signedType(charType()))), protoFunctionType([pointerType(nilQualifier(), builtinType(consQualifier(constQualifier(location=builtinLoc("host")), nilQualifier()), signedType(charType()))), builtinType(nilQualifier(), signedType(intType()))], false), nilQualifier()),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__builtin_strdup", builtinFunctionValueItem( {-  char * (const char * ) -}
    functionType(pointerType(nilQualifier(), builtinType(nilQualifier(), signedType(charType()))), protoFunctionType([pointerType(nilQualifier(), builtinType(consQualifier(constQualifier(location=builtinLoc("host")), nilQualifier()), signedType(charType())))], false), nilQualifier()),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_strlen", builtinFunctionValueItem( {-  signed int(const char * ) -}
    functionType(builtinType(nilQualifier(), signedType(intType())), protoFunctionType([pointerType(nilQualifier(), builtinType(consQualifier(constQualifier(location=builtinLoc("host")), nilQualifier()), signedType(charType())))], false), nilQualifier()),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__builtin_snprintf", builtinFunctionValueItem( {-  signed int(char * , signed int, const char * , ...) -}
    functionType(builtinType(nilQualifier(), signedType(intType())), protoFunctionType([pointerType(nilQualifier(), builtinType(nilQualifier(), signedType(charType()))), builtinType(nilQualifier(), signedType(intType())), pointerType(nilQualifier(), builtinType(consQualifier(constQualifier(location=builtinLoc("host")), nilQualifier()), signedType(charType())))], true), nilQualifier()),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_vsprintf", builtinFunctionValueItem( {-  signed int(char * , const char * , void) -}
    functionType(builtinType(nilQualifier(), signedType(intType())), protoFunctionType([pointerType(nilQualifier(), builtinType(nilQualifier(), signedType(charType()))), pointerType(nilQualifier(), builtinType(consQualifier(constQualifier(location=builtinLoc("host")), nilQualifier()), signedType(charType()))), builtinType(nilQualifier(), voidType())], false), nilQualifier()),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__builtin___strlcat_chk", builtinFunctionValueItem( {-  signed int(char * , const char * , signed int, signed int) -}
    functionType(builtinType(nilQualifier(), signedType(intType())), protoFunctionType([pointerType(nilQualifier(), builtinType(nilQualifier(), signedType(charType()))), pointerType(nilQualifier(), builtinType(consQualifier(constQualifier(location=builtinLoc("host")), nilQualifier()), signedType(charType()))), builtinType(nilQualifier(), signedType(intType())), builtinType(nilQualifier(), signedType(intType()))], false), nilQualifier()),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__builtin___printf_chk", builtinFunctionValueItem( {-  signed int(signed int, const char * , ...) -}
    functionType(builtinType(nilQualifier(), signedType(intType())), protoFunctionType([builtinType(nilQualifier(), signedType(intType())), pointerType(nilQualifier(), builtinType(consQualifier(constQualifier(location=builtinLoc("host")), nilQualifier()), signedType(charType())))], true), nilQualifier()),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__builtin___vprintf_chk", builtinFunctionValueItem( {-  signed int(signed int, const char * , void) -}
    functionType(builtinType(nilQualifier(), signedType(intType())), protoFunctionType([builtinType(nilQualifier(), signedType(intType())), pointerType(nilQualifier(), builtinType(consQualifier(constQualifier(location=builtinLoc("host")), nilQualifier()), signedType(charType()))), builtinType(nilQualifier(), voidType())], false), nilQualifier()),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__builtin_prefetch", builtinFunctionValueItem( {-  void(const void * , ...) -}
    functionType(builtinType(nilQualifier(), voidType()), protoFunctionType([pointerType(nilQualifier(), builtinType(consQualifier(constQualifier(location=builtinLoc("host")), nilQualifier()), voidType()))], true), nilQualifier()),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__atomic_test_and_set", builtinFunctionValueItem( {-  _Bool(volatile void * , signed int) -}
    functionType(builtinType(nilQualifier(), boolType()), protoFunctionType([pointerType(nilQualifier(), builtinType(consQualifier(volatileQualifier(location=builtinLoc("host")), nilQualifier()), voidType())), builtinType(nilQualifier(), signedType(intType()))], false), nilQualifier()),
    ordinaryFunctionHandler))];
d <- [valueDef("__atomic_clear", builtinFunctionValueItem( {-  void(volatile void * , signed int) -}
    functionType(builtinType(nilQualifier(), voidType()), protoFunctionType([pointerType(nilQualifier(), builtinType(consQualifier(volatileQualifier(location=builtinLoc("host")), nilQualifier()), voidType())), builtinType(nilQualifier(), signedType(intType()))], false), nilQualifier()),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__atomic_always_lock_free", builtinFunctionValueItem( {-  signed int(signed int, const volatile void * ) -}
    functionType(builtinType(nilQualifier(), signedType(intType())), protoFunctionType([builtinType(nilQualifier(), signedType(intType())), pointerType(nilQualifier(), builtinType(consQualifier(constQualifier(location=builtinLoc("host")), consQualifier(volatileQualifier(location=builtinLoc("host")), nilQualifier())), voidType()))], false), nilQualifier()),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__sync_fetch_and_min", builtinFunctionValueItem( {-  signed int(volatile signed int * , signed int) -}
    functionType(builtinType(nilQualifier(), signedType(intType())), protoFunctionType([pointerType(nilQualifier(), builtinType(consQualifier(volatileQualifier(location=builtinLoc("host")), nilQualifier()), signedType(intType()))), builtinType(nilQualifier(), signedType(intType()))], false), nilQualifier()),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__sync_fetch_and_umin", builtinFunctionValueItem( {-  unsigned int(volatile unsigned int * , unsigned int) -}
    functionType(builtinType(nilQualifier(), unsignedType(intType())), protoFunctionType([pointerType(nilQualifier(), builtinType(consQualifier(volatileQualifier(location=builtinLoc("host")), nilQualifier()), unsignedType(intType()))), builtinType(nilQualifier(), unsignedType(intType()))], false), nilQualifier()),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__builtin_addcb", builtinFunctionValueItem( {-  unsigned char(const unsigned char, const unsigned char, const unsigned char, unsigned char * ) -}
    functionType(builtinType(nilQualifier(), unsignedType(charType())), protoFunctionType([builtinType(consQualifier(constQualifier(location=builtinLoc("host")), nilQualifier()), unsignedType(charType())), builtinType(consQualifier(constQualifier(location=builtinLoc("host")), nilQualifier()), unsignedType(charType())), builtinType(consQualifier(constQualifier(location=builtinLoc("host")), nilQualifier()), unsignedType(charType())), pointerType(nilQualifier(), builtinType(nilQualifier(), unsignedType(charType())))], false), nilQualifier()),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_addcs", builtinFunctionValueItem( {-  unsigned short(const unsigned short, const unsigned short, const unsigned short, unsigned short * ) -}
    functionType(builtinType(nilQualifier(), unsignedType(shortType())), protoFunctionType([builtinType(consQualifier(constQualifier(location=builtinLoc("host")), nilQualifier()), unsignedType(shortType())), builtinType(consQualifier(constQualifier(location=builtinLoc("host")), nilQualifier()), unsignedType(shortType())), builtinType(consQualifier(constQualifier(location=builtinLoc("host")), nilQualifier()), unsignedType(shortType())), pointerType(nilQualifier(), builtinType(nilQualifier(), unsignedType(shortType())))], false), nilQualifier()),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_addc", builtinFunctionValueItem( {-  unsigned int(const unsigned int, const unsigned int, const unsigned int, unsigned int * ) -}
    functionType(builtinType(nilQualifier(), unsignedType(intType())), protoFunctionType([builtinType(consQualifier(constQualifier(location=builtinLoc("host")), nilQualifier()), unsignedType(intType())), builtinType(consQualifier(constQualifier(location=builtinLoc("host")), nilQualifier()), unsignedType(intType())), builtinType(consQualifier(constQualifier(location=builtinLoc("host")), nilQualifier()), unsignedType(intType())), pointerType(nilQualifier(), builtinType(nilQualifier(), unsignedType(intType())))], false), nilQualifier()),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_addcl", builtinFunctionValueItem( {-  unsigned long(const unsigned long, const unsigned long, const unsigned long, unsigned long * ) -}
    functionType(builtinType(nilQualifier(), unsignedType(longType())), protoFunctionType([builtinType(consQualifier(constQualifier(location=builtinLoc("host")), nilQualifier()), unsignedType(longType())), builtinType(consQualifier(constQualifier(location=builtinLoc("host")), nilQualifier()), unsignedType(longType())), builtinType(consQualifier(constQualifier(location=builtinLoc("host")), nilQualifier()), unsignedType(longType())), pointerType(nilQualifier(), builtinType(nilQualifier(), unsignedType(longType())))], false), nilQualifier()),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_addcll", builtinFunctionValueItem( {-  unsigned long long(const unsigned long long, const unsigned long long, const unsigned long long, unsigned long long * ) -}
    functionType(builtinType(nilQualifier(), unsignedType(longlongType())), protoFunctionType([builtinType(consQualifier(constQualifier(location=builtinLoc("host")), nilQualifier()), unsignedType(longlongType())), builtinType(consQualifier(constQualifier(location=builtinLoc("host")), nilQualifier()), unsignedType(longlongType())), builtinType(consQualifier(constQualifier(location=builtinLoc("host")), nilQualifier()), unsignedType(longlongType())), pointerType(nilQualifier(), builtinType(nilQualifier(), unsignedType(longlongType())))], false), nilQualifier()),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__builtin_uadd_overflow", builtinFunctionValueItem( {-  _Bool(const unsigned int, const unsigned int, unsigned int * ) -}
    functionType(builtinType(nilQualifier(), boolType()), protoFunctionType([builtinType(consQualifier(constQualifier(location=builtinLoc("host")), nilQualifier()), unsignedType(intType())), builtinType(consQualifier(constQualifier(location=builtinLoc("host")), nilQualifier()), unsignedType(intType())), pointerType(nilQualifier(), builtinType(nilQualifier(), unsignedType(intType())))], false), nilQualifier()),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_uaddl_overflow", builtinFunctionValueItem( {-  _Bool(const unsigned long, const unsigned long, unsigned long * ) -}
    functionType(builtinType(nilQualifier(), boolType()), protoFunctionType([builtinType(consQualifier(constQualifier(location=builtinLoc("host")), nilQualifier()), unsignedType(longType())), builtinType(consQualifier(constQualifier(location=builtinLoc("host")), nilQualifier()), unsignedType(longType())), pointerType(nilQualifier(), builtinType(nilQualifier(), unsignedType(longType())))], false), nilQualifier()),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_uaddll_overflow", builtinFunctionValueItem( {-  _Bool(const unsigned long long, const unsigned long long, unsigned long long * ) -}
    functionType(builtinType(nilQualifier(), boolType()), protoFunctionType([builtinType(consQualifier(constQualifier(location=builtinLoc("host")), nilQualifier()), unsignedType(longlongType())), builtinType(consQualifier(constQualifier(location=builtinLoc("host")), nilQualifier()), unsignedType(longlongType())), pointerType(nilQualifier(), builtinType(nilQualifier(), unsignedType(longlongType())))], false), nilQualifier()),
    ordinaryFunctionHandler))];
...
d <- [valueDef("__builtin_sadd_overflow", builtinFunctionValueItem( {-  _Bool(const signed int, const signed int, signed int * ) -}
    functionType(builtinType(nilQualifier(), boolType()), protoFunctionType([builtinType(consQualifier(constQualifier(location=builtinLoc("host")), nilQualifier()), signedType(intType())), builtinType(consQualifier(constQualifier(location=builtinLoc("host")), nilQualifier()), signedType(intType())), pointerType(nilQualifier(), builtinType(nilQualifier(), signedType(intType())))], false), nilQualifier()),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_saddl_overflow", builtinFunctionValueItem( {-  _Bool(const signed long, const signed long, signed long * ) -}
    functionType(builtinType(nilQualifier(), boolType()), protoFunctionType([builtinType(consQualifier(constQualifier(location=builtinLoc("host")), nilQualifier()), signedType(longType())), builtinType(consQualifier(constQualifier(location=builtinLoc("host")), nilQualifier()), signedType(longType())), pointerType(nilQualifier(), builtinType(nilQualifier(), signedType(longType())))], false), nilQualifier()),
    ordinaryFunctionHandler))];
d <- [valueDef("__builtin_saddll_overflow", builtinFunctionValueItem( {-  _Bool(const signed long long, const signed long long, signed long long * ) -}
    functionType(builtinType(nilQualifier(), boolType()), protoFunctionType([builtinType(consQualifier(constQualifier(location=builtinLoc("host")), nilQualifier()), signedType(longlongType())), builtinType(consQualifier(constQualifier(location=builtinLoc("host")), nilQualifier()), signedType(longlongType())), pointerType(nilQualifier(), builtinType(nilQualifier(), signedType(longlongType())))], false), nilQualifier()),
    ordinaryFunctionHandler))];
