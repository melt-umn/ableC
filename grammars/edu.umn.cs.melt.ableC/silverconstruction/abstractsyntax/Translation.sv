...
top::AST ::= prodName::String children::ASTs annotations::NamedASTs
{
  ...
  collectionAntiquoteProductions <-
    [("edu:umn:cs:melt:ableC:silverconstruction:abstractsyntax:antiquoteDecls",
     ...
     ("edu:umn:cs:melt:ableC:silverconstruction:abstractsyntax:antiquoteInitList",
      "InitList",
      "edu:umn:cs:melt:ableC:abstractsyntax:host:consInit",
      "edu:umn:cs:melt:ableC:abstractsyntax:host:nilInit",
      "edu:umn:cs:melt:ableC:abstractsyntax:host:appendInitList"),
